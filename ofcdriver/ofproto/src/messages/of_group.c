...
int32_t of_group_frame_action_request(struct of_msg *msg, struct ofi_action  *action_p)
{
  ...
  switch(action_p->type)
  {
    ...
    case   OFPAT_SET_FIELD: /* Set a header field using OXM TLV format. */
      ...
      retval = of_group_set_action_setfield(msg,action_p);
      if (retval != OFU_ACTION_PUSH_SUCCESS)
      {
	      OF_LOG_MSG(OF_LOG_MOD, OF_LOG_ERROR," of_group_set_action_setfield failed!");
	      status=OF_FAILURE;
	      break;
      }
    ...
    case OFPAT_EXPERIMENTER:
      {
        ...
        switch(action_p->sub_type)
        {
          ...
          case FSLXAT_IP_FRAGMENT:
            {
	      retval = fslx_action_ipfragment(msg, NXM_NX_REG2, 0, 32, action_p->ui32_data);
              if (retval != OFU_ACTION_PUSH_SUCCESS)
              {
...
{
	int32_t retval ;
	OF_LOG_MSG(OF_LOG_MOD, OF_LOG_ALL," of_group_set_action_setfield Entered .setfield_type:%d",action->setfield_type);
	do
	{
		switch (action->setfield_type)
		{
			...
			case OFPXMT_OFB_ETH_DST: /* Ethernet destination address. */
				{
					OF_LOG_MSG(OF_LOG_MOD, OF_LOG_DEBUG,"OFPXMT_OFB_ETH_DST:");
					retval = ofu_push_set_destination_mac_in_set_field_action(msg, (char *)action->ui8_data_array);
			...
			case  OFPXMT_OFB_VLAN_PCP:
				{
					OF_LOG_MSG(OF_LOG_MOD, OF_LOG_DEBUG,"OFPXMT_OFB_VLAN_PCP:");
					retval = ofu_push_set_vlan_priority_bits_in_set_field_action(msg, &action->ui8_data);
					if (retval != OFU_ACTION_PUSH_SUCCESS)
					{
						OF_LOG_MSG(OF_LOG_MOD, OF_LOG_ERROR, " Setting action set  field failed...");
						retval = OF_FAILURE;
			 ...
			 case OFPXMT_OFB_IPV6_SRC:
				{
					...
					retval = ofu_push_set_source_ipv6_addr_in_set_field_action(msg, &(action->ipv6_addr));
					if (retval != OFU_ACTION_PUSH_SUCCESS)
					{
			 ...
			 case OFPXMT_OFB_IPV6_DST:
				{
					...
					retval = ofu_push_set_destination_ipv6_addr_in_set_field_action(msg, &(action->ipv6_addr));
					if (retval != OFU_ACTION_PUSH_SUCCESS)
					{
...
int32_t of_group_frame_message_request(struct of_msg *msg, struct ofi_group_desc_info *group_entry_p)
{
  ...
  struct ofi_bucket *bucket_entry_p;
  int32_t retval;
  int32_t status=OFU_APPEND_BUCKET_SUCCESS;
    ...
    case   OFPAT_SET_QUEUE: /* Set queue id when outputting to a port */
      {
        ...
        OF_LOG_MSG(OF_LOG_MOD, OF_LOG_DEBUG,"OFPAT_SET_QUE:");
        set_queue = (struct ofp_action_set_queue *)msg;
        action_entry_p->queue_id = ntohl(set_queue->queue_id);
        OF_LOG_MSG(OF_LOG_MOD, OF_LOG_DEBUG," action_entry_p->queue_id %d\r\n",action_entry_p->queue_id);
    ...
    case   OFPAT_SET_FIELD: /* Set a header field using OXM TLV format. */
      {
        ...
        of_group_frame_action_setField_response(msg,action_entry_p);
    ...
    case OFPAT_EXPERIMENTER:
      {
	      ...
	      switch(fslx_action->subtype)
	      {
		      case FSLXAT_ARP_RESPONSE:
			      {
				      struct fslx_action_arp_response *fslx_action = (struct fslx_action_arp_response *)msg;
		      ...
		      case FSLXAT_IP_FRAGMENT:
			      {
				      struct fslx_action_ip_fragment *fslx_action = (struct fslx_action_ip_fragment *)msg;
		      ...
		      case FSLXAT_SEND_ICMPV4_DEST_UNREACHABLE:
			      {
				      struct fslx_action_icmpv4_dest_unreachable *fslx_action = (struct fslx_action_icmpv4_dest_unreachable *)msg;
		      ...
		      case FSLXAT_SEND_ICMPV4_TIME_EXCEED:
			      {
				      struct fslx_action_icmpv4_time_exceed *fslx_action = (struct fslx_action_icmpv4_time_exceed *)msg;
				      action_entry_p->ui8_data = fslx_action->code;
		      ...
		      case FSLXAT_SET_PHY_PORT_FIELD_CNTXT:
			      {
				      struct fslx_action_set_in_phy_port_cntxt *fslx_action = (struct fslx_action_set_in_phy_port_cntxt *)msg;
		      ...
		      case FSLXAT_SET_META_DATA_FIELD_CNTXT:
			      {
				      struct fslx_action_meta_data_cntxt *fslx_action = (struct fslx_action_meta_data_cntxt *)msg;
		      ...
		      case FSLXAT_SET_TUNNEL_ID_FIELD_CNTXT:
			      {
				      struct fslx_action_tunnel_id_cntxt *fslx_action = (struct fslx_action_tunnel_id_cntxt *)msg;
		      ...
		      case FSLXAT_START_TABLE:
			      {
				      struct fslx_action_start_table *fslx_action = (struct fslx_action_start_table *)msg;
		      ...
		      case FSLXAT_WRITE_METADATA_FROM_PKT:
			      {
				      struct fslx_action_wr_metadata_from_pkt *fslx_action = (struct fslx_action_wr_metadata_from_pkt *)msg;
		      ...
		      case FSLXAT_WRITE_META_DATA:
			      {
				      struct fslxat_write_metadata *fslx_action = (struct fslxat_write_metadata *)msg;
				      action_entry_p->ui64_data = fslx_action->meta_data;
		      ...
		      case FSLXAT_DETACH_BIND_OBJ:
			      {
				      struct fslx_action_detach_bind_obj *fslx_action = (struct fslx_action_detach_bind_obj *)msg;
		      ...
		      case FSLXAT_SEND_APP_STATE_INFO:
			      {
				      struct fslx_action_send_app_state_info *fslx_action = (struct fslx_action_send_app_state_info *)msg;
		      ...
		      case FSLXAT_BIND_OBJECT_APPLY_ACTIONS:
			      {
				      struct fslx_action_execute_bind_obj_apply_actns *fslx_action = (struct fslx_action_execute_bind_obj_apply_actns *)msg;
				      action_entry_p->ui32_data = fslx_action->bind_obj_id;
		      ...
		      case NXAST_COPY_FIELD:
			      {
				      struct eric_action_copy_field *eric_action = (struct eric_action_copy_field *)msg;
...
int32_t of_group_frame_action_setField_response(char *msg,struct ofi_action *action_entry_p)
{
