...
#define LINUX_PSEUDO_ETH_NUM_CORES		(2)
#define CNTLR_DFLT_NUM_TRANSPORT_THREADS        (2) 
#define CNTLR_DFLT_NUM_PETH_THREADS             (2)

#elif CONFIG_BOARD_P2041

#define LINUX_PSEUDO_ETH_STARTING_CORE_ID	(2)
#define LINUX_PSEUDO_ETH_NUM_CORES		(1)
#define CNTLR_DFLT_NUM_TRANSPORT_THREADS        (1) 
#define CNTLR_DFLT_NUM_PETH_THREADS             (1)

#elif CONFIG_BOARD_T4240
#define LINUX_PSEUDO_ETH_STARTING_CORE_ID       (12)
#define LINUX_PSEUDO_ETH_NUM_CORES              (6)
#define CNTLR_DFLT_NUM_TRANSPORT_THREADS        (6) 
#define CNTLR_DFLT_NUM_PETH_THREADS             (6)

#else

#define LINUX_PSEUDO_ETH_STARTING_CORE_ID	(1)
#define LINUX_PSEUDO_ETH_NUM_CORES		(1)
#define CNTLR_DFLT_NUM_TRANSPORT_THREADS        (1)
#define CNTLR_DFLT_NUM_PETH_THREADS             (1)
...
/* One for Routing listener, one for Ipsec listener , one for Firewall */
#define CNTLR_NUM_APPLICATION_THREADS	(3)
...
struct library_handles
{
 char dir_path[CNTLR_MAX_DIR_PATH_LEN];
 void *handle_p[MAX_LIBRARIES];
 int32_t max_lib_index;
 int8_t valid_b;
};
