...
{\
 OF_LOG_MSG(OF_NEM_LOG, OF_LOG_DEBUG, "nem db entry dpid=%llx ns-id=%d port-id=%d peth-name=%s peth-id=%d",map_entry_p->dp_peth_info.dp_id,map_entry_p->dp_peth_info.ns_id, map_entry_p->dp_peth_info.port_id,map_entry_p->dp_peth_info.peth_name, map_entry_p->dp_peth_info.peth_id);\
}

#define NEM_PRINT_DPID_AND_PETH_MAP_INFO(dp_peth_info_p) \
{\
 OF_LOG_MSG(OF_NEM_LOG, OF_LOG_DEBUG, "nem info dpid=%llx  ns-id=%d port-id=%d peth-name=%s peth-id=%d",dp_peth_info_p->dp_id, dp_peth_info_p->ns_id,dp_peth_info_p->port_id, dp_peth_info_p->peth_name,dp_peth_info_p->peth_id);\
}
...
#define DPID_DPNSID_MAPNODE_HASH_TBLLNK_OFFSET offsetof(struct nem_dpid_and_dpnsid_map_entry,hash_tbl_link);
