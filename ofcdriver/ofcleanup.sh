...
nohup nscs-agent --config-file /usr/local/etc/nscsas/nscs.conf --config-file /usr/local/etc/nscsas/consumer.conf --log-file /var/log/crd/consumer.log > /var/log/crd/consumer.log 2>&1 &
