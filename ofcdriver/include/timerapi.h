...
#define TIMER_DEFAULT_CONTAINER_TIMER_ENTRIES_MAX  uiCntrlTmrMaxNodeCnt_g
#else
#define TIMER_DEFAULT_CONTAINER_TIMER_ENTRIES_MAX  1048576 
#endif
...
/** \ingroup Timer_Management
  ...
  */
#define TIMER_DAFAULT_CONTAINER_TIMER_STATIC_ENTRIES_MAX (TIMER_DEFAULT_CONTAINER_TIMER_ENTRIES_MAX/4)
