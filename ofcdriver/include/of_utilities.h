...
struct of_msg{
/** offset */
    uint32_t  pkt_mbuf_offset; /* offset to struct of_msg in pkt_buf skip area */
...
/** \ingroup Match_Fields 
 * OFU_SRC_IP_RANGE_LEN
 *   -Returns length of buffer required for SRC IP RANGE field
 */
#define  OFU_SRC_IP_RANGE_LEN             16

/** \ingroup Match_Fields 
 *  OFU_DEST_IP_RANGE_LEN
 *   -Returns length of buffer required for DEST IP RANGE field
 */
#define  OFU_DEST_IP_RANGE_LEN             16

/** \ingroup Match_Fields 
 *  OFU_TCP_SRC_PORT_RANGE_LEN
 *   -Returns length of buffer required for SRC PORT RANGE field
 */
#define  OFU_UDP_SRC_PORT_RANGE_LEN             12

/** \ingroup Match_Fields 
 *  OFU_TCP_DEST_PORT_RANGE_LEN
 *   -Returns length of buffer required for DEST PORT RANGE field
 */
#define  OFU_UDP_DEST_PORT_RANGE_LEN             12

/** \ingroup Match_Fields 
 *  OFU_TCP_SRC_PORT_RANGE_LEN
 *   -Returns length of buffer required for SRC PORT RANGE field
 */
#define  OFU_TCP_SRC_PORT_RANGE_LEN             12

/** \ingroup Match_Fields 
 *  OFU_TCP_DEST_PORT_RANGE_LEN
 *   -Returns length of buffer required for DEST PORT RANGE field
 */
#define  OFU_TCP_DEST_PORT_RANGE_LEN             12


/** \ingroup Match_Fields 
 *  OFU_TCP_FLAGS_MASK_LEN
 *   -Returns length of buffer required for TCP FLAGS field
 */
#define  OFU_TCP_FLAGS_MASK_LEN        10

/** \ingroup Match_Fields 
 *  OFU_TCP_FLAGS_LEN
 *   -Returns length of buffer required for TCP FLAGS field
 */
#define  OFU_TCP_FLAGS_LEN             9
...
/** \ingroup Match_Fields 
 *   OFU_TEMPLATE_MATCH_LEN
 *   - Returns length of the buffer required for 'Template Match Field'
 */

#define  OFU_TEMPLATE_MATCH_LEN           sizeof(struct ofp_oxm_template)
