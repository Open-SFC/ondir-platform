...
typedef struct of_ip4_mcfwd_mfe_info
{
...
}of_ip4_mcfwd_mfe_info_t;


/****************************************************************************************
 * * * * * * * * * * * * * * * FUNCTION PROTOTYPES * * * * * * * * * * * * * * * * * * *
 *****************************************************************************************/
int32_t of_ip4_mcfwd_mfe_get_first_record(uint32_t ns_id,struct of_ip4_mcfwd_mfe_info *mcast_rec_p);
int32_t of_ip4_mcfwd_mfe_get_next_record(uint32_t ns_id, struct of_ip4_mcfwd_mfe_info *mcast_rec_p);
int32_t of_ip4_mcfwd_mfe_get_exact_record(uint32_t ns_id, struct of_ip4_mcfwd_mfe_info *mcast_rec_p);
