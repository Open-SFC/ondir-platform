...
struct ofi_table_stats_info
{
    ...
    /** Total Number of flowmods received */
    uint64_t  total_flows_received;

    /** Number of flowmods failed */
    uint64_t  flow_failed_count;
...
#define OFU_METER_CONFIG_REQ_MESSAGE_LEN sizeof(struct ofp_multipart_request)+sizeof(struct ofp_meter_multipart_request)
#define OFU_METER_FEATURE_REQ_MESSAGE_LEN sizeof(struct ofp_multipart_request)
#define OFU_METER_STATS_REQ_MESSAGE_LEN sizeof(struct ofp_multipart_request) + sizeof(struct ofp_meter_multipart_request)
...
struct ofi_meter_band_stats
{
   /** next band */
   of_list_node_t     next_band_stats;
   /** Number of packets in by meter. */ 
   uint64_t packet_count;
   /** Number of bytes in by meter. */
   uint64_t byte_count;
};   
#define OF_METER_BAND_STATS_LISTNODE_OFFSET offsetof(struct ofi_meter_band_stats, next_band_stats)
