...
int32_t of_ttp_tbl_setmandparams (struct cm_array_of_iv_pairs *
    pMandParams,
    struct ttprm_tbl_info * of_ttp_tbl_node,
    struct ttprm_config_info  *of_ttp_node);

int32_t of_ttp_tbl_getparams (struct ttprm_tbl_info *of_ttp_tbl_node,
    ...
    struct cm_array_of_iv_pairs ** array_of_iv_pair_arr_p)
{
  ...
  CM_CBK_DEBUG_PRINT ("entry");
  of_memset (&of_ttp_tbl_node, 0, sizeof (struct ttprm_tbl_info));
  of_memset (&of_ttp_node, 0, sizeof (struct ttprm_config_info));
...
int32_t of_ttp_tbl_setmandparams (struct cm_array_of_iv_pairs *
    pMandParams, struct ttprm_tbl_info * of_ttp_tbl_node,
    struct ttprm_config_info  *of_ttp_node)
{
