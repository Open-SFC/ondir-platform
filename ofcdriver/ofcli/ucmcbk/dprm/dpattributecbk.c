...

{
	 ...
	 int32_t  return_value = OF_FAILURE;
         struct   dprm_attribute_name_value_pair dprm_attribute_name_value_info={};
	 struct   dprm_attribute_name_value_output_info dprm_attribute_name_output_info={};
	 struct   dprm_datapath_general_info datapath_info={};
	 uint64_t datapath_handle;
	 ...
	 return_value = dprm_get_datapath_exact_attribute_name(datapath_handle, dprm_attribute_name_output_info.name_string);
	 if (return_value != OF_SUCCESS)
	 {
         ...
         dprm_attribute_getparams (&dprm_attribute_name_output_info, result_iv_pairs_p);
