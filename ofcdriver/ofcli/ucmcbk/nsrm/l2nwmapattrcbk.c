...
int32_t nsrm_l2nw_map_attribute_appl_ucmcbk_init (void)
{
  ...
  if(cm_register_app_callbacks (CM_ON_DIRECTOR_NSRM_NETWORKMAP_L2NETWORKMAPATTRIBUTE_APPL_ID, &nsrm_l2nw_map_attribute_ucm_callbacks) != OF_SUCCESS)
    return OF_FAILURE;
                                     ...
                                     struct cm_app_result ** result_p)
{
  ...
  l2nw_map_name_p = (char*)of_calloc(1,NSRM_MAX_NAME_LENGTH);
   ...
   {  
     ...
     switch (pMandParams->iv_pairs[uiMandParamCnt].id_ui)
     {
      ...
      case CM_DM_L2NETWORKMAPATTRIBUTE_ATTRIBUTENAME_ID:
            attribute_info->attribute_name_p = (char*)of_calloc(1,NSRM_MAX_NAME_LENGTH);
     ...
     case CM_DM_L2NETWORKMAPATTRIBUTE_ATTRIBUTEVALUE_ID:
           attribute_info->attribute_value_p = (char*)of_calloc(1,NSRM_MAX_NAME_LENGTH);
