...
CM_LINCLUDES  +=  -I $(cminfra_dir)/infra/dm/include
...
CONTRLR_INCLUDES = -I $(CONTRLR_DIR)/ofproto/include\
		   ...
		   -I $(ext_dir)/urcu\
		   -I $(CONTRLR_DIR)/../sdrouter-app/api-dispatcher/include/nfapis/\
		   -I $(CONTRLR_DIR)/../sdrouter-app/api-dispatcher/include/nfapis/common/\
		   -I $(CONTRLR_DIR)/../sdrouter-app/api-dispatcher/include/nfapis/firewall\
		   -I $(CONTRLR_DIR)/../sdrouter-app/linux-integration/ip4-fwnat/include\
		   -I $(CONTRLR_DIR)/../sdrouter-app/api-dispatcher/include/nfapis/nfinfra\
		   -I $(CONTRLR_DIR)/../sdrouter-app/linux-integration/arp/src\
		   -I $(CONTRLR_DIR)/../cmn-sub-ttps/ip4-fwnat/include/\
		   -I $(CONTRLR_DIR)/../cmn-sub-ttps/arp-resolution/include/\
		   -I $(CONTRLR_DIR)/../cmn-sub-ttps/include/\
		   -I $(CONTRLR_DIR)/../cmn-sub-ttps/ip4-unicast/include/\
		   -I $(CONTRLR_DIR)/../sdrouter-app/api-dispatcher/arp/include/\
		   -I $(ext_dir)/futex
