...
/* Namespace error messages */
  ...
  "Namespace name length exceeded",
   ...
   "GoToTable id must be greater than the current table id",
   ...
   "firewall connection template record add failed",
   "firewall connection template record del failed",
   "firewall connection template protocol is null",
   "firewall connection template dst port is null",
