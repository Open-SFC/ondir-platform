...
int32_t of_nem_dpid2nsid_getfirstnrecs (struct cm_array_of_iv_pairs * key_iv_pairs_p,
      uint32_t * count_p,
      struct cm_array_of_iv_pairs ** array_of_iv_pair_arr_p);

int32_t of_nem_dpid2nsid_getnextnrecs (struct cm_array_of_iv_pairs * key_iv_pairs_p,
      struct cm_array_of_iv_pairs * prev_record_key_p, uint32_t * count_p,
      struct cm_array_of_iv_pairs ** next_n_record_data_p);

int32_t of_nem_dpid2nsid_getexactrec (struct cm_array_of_iv_pairs * key_iv_pairs_p,
      struct cm_array_of_iv_pairs ** pIvPairArr);


/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * * * * * * * DPID2NSID  U T I L I T Y  F U N C T I O N S * * * * * * * * * * *
 * * * * * * * * * * * * * **  * * * * * * * **  * * * * * * * * * * * * * */
int32_t of_nem_dpid2nsid_ucm_validatemandparams (struct cm_array_of_iv_pairs *
      mand_iv_pairs_p,
      struct cm_app_result **
      presult_p);

int32_t of_nem_dpid2nsid_ucm_validateoptparams (struct cm_array_of_iv_pairs *
      opt_iv_pairs_p,
      struct cm_app_result ** presult_p);


int32_t of_nem_dpid2nsid_ucm_setmandparams (struct cm_array_of_iv_pairs *
      mand_iv_pairs_p,
      struct of_nem_dp_ns_info * nem_map_info,
      struct cm_app_result ** presult_p);

int32_t of_nem_dpid2nsid_ucm_setoptparams (struct cm_array_of_iv_pairs *
      opt_iv_pairs_p,
      struct of_nem_dp_ns_info * nem_map_info,
      struct cm_app_result ** presult_p);


int32_t of_nem_dpid2nsid_ucm_getparams (struct of_nem_dp_ns_info *nem_map_info,
      struct cm_array_of_iv_pairs * result_iv_pairs_p);



struct cm_dm_app_callbacks of_nem_dpid2nsid_ucm_callbacks = {
   NULL,
   NULL,
   NULL,
   NULL,
   NULL,
   of_nem_dpid2nsid_getfirstnrecs,
   of_nem_dpid2nsid_getnextnrecs,
   of_nem_dpid2nsid_getexactrec,
   NULL,
   NULL
};
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      ...
      struct cm_array_of_iv_pairs ** array_of_iv_pair_arr_p)
{
   ...
   ret_val=of_nem_dpid_2_nsid_db_get_first_map_entry(&nem_map_info,  &nem_db_entry_handle);
   ...
   of_nem_dpid2nsid_ucm_getparams (&nem_map_info, &result_iv_pairs_p[uiRecCount]);
   uiRecCount++;
      ...
      struct cm_array_of_iv_pairs ** next_n_record_data_p)
{
   ...
   if ((of_nem_dpid2nsid_ucm_setmandparams (prev_record_key_p, &nem_map_info, &app_result_p)) !=
         OF_SUCCESS)
   {
   ...
   ret_val=of_nem_dpid_2_nsid_db_get_map_entry_handle(nem_map_info.dp_id, nem_map_info.dp_ns_id, &nem_db_entry_handle);
   if (ret_val != OF_SUCCESS)
   {
      CM_CBK_DEBUG_PRINT ("Error: nem entry does not exist with dpid  %llx nsid %d",nem_map_info.dp_id, nem_map_info.dp_ns_id);
      return OF_FAILURE;
   }

   of_memset (&nem_map_info, 0, sizeof (struct of_nem_dp_ns_info));
   ret_val=of_nem_dpid_2_nsid_db_get_next_map_entry(&nem_map_info, &nem_db_entry_handle);
   if (ret_val != OF_SUCCESS)
   {
      ...
      struct cm_array_of_iv_pairs ** pIvPairArr)
{
   ...
   if ((of_nem_dpid2nsid_ucm_setmandparams (key_iv_pairs_p, &nem_map_info, &of_nem_result)) !=
         OF_SUCCESS)
   {
      CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
      return OF_FAILURE;
   ...
   if (ret_val != OF_SUCCESS)
   {
      CM_CBK_DEBUG_PRINT ("Error: nem entry does not exist with dpid %llx",nem_map_info.dp_id);
      return OF_FAILURE;
   }

   of_memset (&nem_map_info, 0, sizeof (struct of_nem_dp_ns_info));
   ret_val=of_nem_dpid_2_nsid_db_get_exact_map_entry(nem_db_entry_handle, &nem_map_info);
   if (ret_val != OF_SUCCESS)
   {
   ...
   of_nem_dpid2nsid_ucm_getparams (&nem_map_info, result_iv_pairs_p);
         ...
         count++)
   {
      switch (mand_iv_pairs_p->iv_pairs[count].id_ui)
      {
         case CM_DM_DPID2NSID_NSID_ID:
            ...
            break;
         case CM_DM_DPID2NSID_DPNSID_ID:
            dp_ns_id=of_atoi((char *) mand_iv_pairs_p->iv_pairs[count].value_p);
            nem_map_info->dp_ns_id=(uint16_t )dp_ns_id;
            break;
         case CM_DM_DPID2NSID_DPID_ID:
      ...
      struct cm_array_of_iv_pairs * result_iv_pairs_p)
{
   uint32_t index_ui = 0;
   char buf[10] = "";
#define CM_DPID2NSID_CHILD_COUNT 3

   result_iv_pairs_p->iv_pairs =
      (struct cm_iv_pair *) of_calloc (CM_DPID2NSID_CHILD_COUNT, sizeof (struct cm_iv_pair));
   ...
   FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[index_ui],CM_DM_DPID2NSID_DPID_ID,
         CM_DATA_TYPE_STRING, buf);
   index_ui++;

   /*DpNsId*/
   of_itoa (nem_map_info->dp_ns_id, buf);
   FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[index_ui],CM_DM_DPID2NSID_DPNSID_ID,
         CM_DATA_TYPE_STRING, buf);
   index_ui++;

   /*NsId*/
   of_itoa (nem_map_info->ns_id, buf);
   FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[index_ui],CM_DM_DPID2NSID_NSID_ID,
         CM_DATA_TYPE_STRING, buf);
   index_ui++;
