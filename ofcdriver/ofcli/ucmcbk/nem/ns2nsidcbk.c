...
int32_t of_nem_ns2nsid_getfirstnrecs (struct cm_array_of_iv_pairs * key_iv_pairs_p,
      uint32_t * count_p,
      struct cm_array_of_iv_pairs ** array_of_iv_pair_arr_p);

int32_t of_nem_ns2nsid_getnextnrecs (struct cm_array_of_iv_pairs * key_iv_pairs_p,
      struct cm_array_of_iv_pairs * prev_record_key_p, uint32_t * count_p,
      struct cm_array_of_iv_pairs ** next_n_record_data_p);

int32_t of_nem_ns2nsid_getexactrec (struct cm_array_of_iv_pairs * key_iv_pairs_p,
      struct cm_array_of_iv_pairs ** pIvPairArr);


/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * * * * * * * NS2NSID  U T I L I T Y  F U N C T I O N S * * * * * * * * * * *
 * * * * * * * * * * * * * **  * * * * * * * **  * * * * * * * * * * * * * */
int32_t of_nem_ns2nsid_ucm_validatemandparams (struct cm_array_of_iv_pairs *
      mand_iv_pairs_p,
      struct cm_app_result **
      presult_p);

int32_t of_nem_ns2nsid_ucm_validateoptparams (struct cm_array_of_iv_pairs *
      opt_iv_pairs_p,
      struct cm_app_result ** presult_p);


int32_t of_nem_ns2nsid_ucm_setmandparams (struct cm_array_of_iv_pairs *
      mand_iv_pairs_p,
      struct of_nem_ns_info * nem_map_info,
      struct cm_app_result ** presult_p);

int32_t of_nem_ns2nsid_ucm_setoptparams (struct cm_array_of_iv_pairs *
      opt_iv_pairs_p,
      struct of_nem_ns_info * nem_map_info,
      struct cm_app_result ** presult_p);


int32_t of_nem_ns2nsid_ucm_getparams (struct of_nem_ns_info *nem_map_info,
      struct cm_array_of_iv_pairs * result_iv_pairs_p);



struct cm_dm_app_callbacks of_nem_ns2nsid_ucm_callbacks = {
   NULL,
   NULL,
   NULL,
   NULL,
   NULL,
   of_nem_ns2nsid_getfirstnrecs,
   of_nem_ns2nsid_getnextnrecs,
   of_nem_ns2nsid_getexactrec,
   NULL,
   NULL
};
...
int32_t of_nem_ns2nsid_appl_ucmcbk_init (void)
{
   ...
   cm_register_app_callbacks (CM_ON_DIRECTOR_NEM_NS2NSID_APPL_ID, &of_nem_ns2nsid_ucm_callbacks);
   return OF_SUCCESS;
}
      ...
      struct cm_array_of_iv_pairs ** array_of_iv_pair_arr_p)
{
   ...
   ret_val=of_nem_ns_2_nsid_db_get_first_map_entry(&nem_map_info,  &nem_db_entry_handle);
   ...
   of_nem_ns2nsid_ucm_getparams (&nem_map_info, &result_iv_pairs_p[uiRecCount]);
   uiRecCount++;
      ...
      struct cm_array_of_iv_pairs ** next_n_record_data_p)
{
   ...
   if ((of_nem_ns2nsid_ucm_setmandparams (prev_record_key_p, &nem_map_info, &app_result_p)) !=
         OF_SUCCESS)
   {
   ...
   ret_val=of_nem_ns_2_nsid_db_get_map_entry_handle(nem_map_info.name, &nem_db_entry_handle);
   if (ret_val != OF_SUCCESS)
   {
      CM_CBK_DEBUG_PRINT ("Error: nem entry does not exist with name %s",nem_map_info.name);
      return OF_FAILURE;
   }

   of_memset (&nem_map_info, 0, sizeof (struct of_nem_ns_info));
   ret_val=of_nem_ns_2_nsid_db_get_next_map_entry(&nem_map_info, &nem_db_entry_handle);
   if (ret_val != OF_SUCCESS)
   {
      ...
      struct cm_array_of_iv_pairs ** pIvPairArr)
{
   ...
   if ((of_nem_ns2nsid_ucm_setmandparams (key_iv_pairs_p, &nem_map_info, &of_nem_result)) !=
         OF_SUCCESS)
   {
      CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
      return OF_FAILURE;
   ...
   of_memset (&nem_map_info, 0, sizeof (struct of_nem_ns_info));
   ret_val=of_nem_ns_2_nsid_db_get_exact_map_entry(nem_db_entry_handle, &nem_map_info);
   if (ret_val != OF_SUCCESS)
   {
   ...
   of_nem_ns2nsid_ucm_getparams (&nem_map_info, result_iv_pairs_p);
      ...
      struct cm_array_of_iv_pairs * result_iv_pairs_p)
{
   uint32_t uindex_i = 0;
   char buf[10] = "";
#define CM_NS2NSID_CHILD_COUNT 2

   result_iv_pairs_p->iv_pairs =
      (struct cm_iv_pair *) of_calloc (CM_NS2NSID_CHILD_COUNT, sizeof (struct cm_iv_pair));
   ...
   /* Namespace Interface*/
   FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[uindex_i], CM_DM_NS2NSID_NSNAME_ID,
   ...
   FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[uindex_i],CM_DM_NS2NSID_NSID_ID,
