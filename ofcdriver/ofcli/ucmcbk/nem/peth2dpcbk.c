...
int32_t of_nem_peth2dpid_getfirstnrecs (struct cm_array_of_iv_pairs * key_iv_pairs_p,
      uint32_t * count_p,
...
int32_t of_nem_peth2dpid_getexactrec (struct cm_array_of_iv_pairs * key_iv_pairs_p,
      struct cm_array_of_iv_pairs ** pIvPairArr);


/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 * * * * * * * PETH2DPID  U T I L I T Y  F U N C T I O N S * * * * * * * * * * *
 * * * * * * * * * * * * * **  * * * * * * * **  * * * * * * * * * * * * * */
int32_t of_nem_peth2dpid_ucm_validatemandparams (struct cm_array_of_iv_pairs *
      mand_iv_pairs_p,
      struct cm_app_result **
      presult_p);

int32_t of_nem_peth2dpid_ucm_validateoptparams (struct cm_array_of_iv_pairs *
      opt_iv_pairs_p,
      struct cm_app_result ** presult_p);


int32_t of_nem_peth2dpid_ucm_setmandparams (struct cm_array_of_iv_pairs *
      mand_iv_pairs_p,
      struct of_nem_dp_peth_info * nem_map_info,
      struct cm_app_result ** presult_p);

int32_t of_nem_peth2dpid_ucm_setoptparams (struct cm_array_of_iv_pairs *
      opt_iv_pairs_p,
      struct of_nem_dp_peth_info * nem_map_info,
      struct cm_app_result ** presult_p);


int32_t of_nem_peth2dpid_ucm_getparams (struct of_nem_dp_peth_info *nem_map_info,
      struct cm_array_of_iv_pairs * result_iv_pairs_p);



struct cm_dm_app_callbacks of_nem_peth2dpid_ucm_callbacks = {
   NULL,
   NULL,
   NULL,
   NULL,
   NULL,
   of_nem_peth2dpid_getfirstnrecs,
   of_nem_peth2dpid_getnextnrecs,
   of_nem_peth2dpid_getexactrec,
   NULL,
   NULL
};
      ...
      struct cm_array_of_iv_pairs ** array_of_iv_pair_arr_p)
{
   ...
   ret_val=of_nem_peth_2_dpid_db_get_first_map_entry(&nem_map_info,  &nem_db_entry_handle);
      ...
      struct cm_array_of_iv_pairs ** pIvPairArr)
{
   ...
   if ((of_nem_peth2dpid_ucm_setmandparams (key_iv_pairs_p, &nem_map_info, &of_nem_result)) !=
         OF_SUCCESS)
   {
      CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
      return OF_FAILURE;
   ...
   of_memset (&nem_map_info, 0, sizeof (struct of_nem_dp_peth_info));
   ret_val=of_nem_peth_2_dpid_db_get_exact_map_entry(nem_db_entry_handle, &nem_map_info);
   if (ret_val != OF_SUCCESS)
   {
   ...
   of_nem_peth2dpid_ucm_getparams (&nem_map_info, result_iv_pairs_p);
...
#define CM_PETH2DPID_CHILD_COUNT 4

   result_iv_pairs_p->iv_pairs =
      (struct cm_iv_pair *) of_calloc (CM_PETH2DPID_CHILD_COUNT, sizeof (struct cm_iv_pair));
   ...
   FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[index_ui],CM_DM_PETH2DPID_DPID_ID,
         CM_DATA_TYPE_STRING, buf);
   index_ui++;

   /*PortId*/
   of_itoa (nem_map_info->port_id, buf);
   FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[index_ui],CM_DM_PETH2DPID_PORTID_ID,
         CM_DATA_TYPE_STRING, buf);
   index_ui++;
#if 0
   /*port name*/
   strcpy (buf,nem_map_info->port_name);
   FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[index_ui],CM_DM_PETH2DPID_PORTNAME_ID,
         CM_DATA_TYPE_STRING, buf);
   index_ui++;
#endif
   /*peth name*/
   strcpy (buf,nem_map_info->peth_name);
   FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[index_ui],CM_DM_PETH2DPID_PETHNAME_ID,
         CM_DATA_TYPE_STRING, buf);
   index_ui++;

   /*NsId*/
   of_itoa (nem_map_info->ns_id, buf);
   FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[index_ui],CM_DM_PETH2DPID_NSID_ID,
         CM_DATA_TYPE_STRING, buf);
   index_ui++;
