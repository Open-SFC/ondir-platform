...

{
  ...
  return_value = crm_get_tenant_exact_attribute(tenant_handle, crm_attribute_name_value_info.name_string,&crm_attribute_output);
    if (return_value != OF_SUCCESS)
     {
  ...
  crm_attribute_tenant_getparams (&crm_attribute_output, result_iv_pairs_p);
