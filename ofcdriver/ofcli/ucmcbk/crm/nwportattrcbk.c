...

{
  ...
  int32_t  return_value = OF_FAILURE;
  struct   crm_attribute_name_value_pair          crm_attribute_name_value_info={};
  struct   crm_attribute_name_value_output_info   crm_attribute_name_value_output={};
  char     nwport_name[CRM_MAX_VM_NAME_LEN+1]={};
  ...
  return_value = crm_get_port_exact_attribute(nwport_name, crm_attribute_name_value_info.name_string,&crm_attribute_name_value_output);
    if (return_value != OF_SUCCESS)
     {
  ...
  crm_attribute_nwport_getparams (&crm_attribute_name_value_output, result_iv_pairs_p);
