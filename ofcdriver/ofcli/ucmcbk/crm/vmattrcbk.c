...

{
  ...
  return_value = crm_get_vm_exact_attribute(vm_handle, crm_attribute_name_value_info.name_string,&crm_attribute_name_value_output);
    if (return_value != OF_SUCCESS)
     {
  ...
  crm_attribute_vm_getparams (&crm_attribute_name_value_output, result_iv_pairs_p);
