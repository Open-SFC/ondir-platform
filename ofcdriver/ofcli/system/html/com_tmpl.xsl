            ...
            <xsl:choose>
              ...
              <xsl:when test="not(@ftyp)">
                  ...
                  <xsl:choose>
                    <xsl:when test="@title and @act='expcol'">
                      ...
                      <span style="position:relative;" class="addRecord">
                        ...
                        <a href="#">
                        <font size="3"><xsl:value-of select="@title"/></font>
                      </a></span>
                    </xsl:when>
                    <xsl:when test="@title and not(@act)">
                      <b><xsl:value-of select="@title" /></b>
                  ...
                  <div class="grpDiv">
                   ...
                   <xsl:if test="@showMore='yes'">
                     <span style="position:relative; float:right" class="addRecord">
                        <xsl:attribute name="onclick">
                          <xsl:text>createDivMore('</xsl:text>
                          <xsl:value-of select="@name"/>
                          <xsl:text>', this);</xsl:text>
                        </xsl:attribute>
                        <a href="#"><font size="2">More <xsl:value-of select="@title"/>...</font></a>
                        <input type="hidden" value="moreDivInnerHTML">
                        <xsl:attribute name="name">
                          <xsl:value-of select="@name"/>
                        </xsl:attribute> 
                        </input>                         
