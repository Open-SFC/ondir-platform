...
uint32_t uiCntrlTmrMaxNodeCnt_g = (1024 * 1024); /* default number of timer node */
...
extern int32_t get_value_from_cntrl_resource_conf_xml(char *pDatapathNodeName, char *pChildNodeName, char *pParamName, uint32_t *value);
...
#ifdef OF_TIMER_XML_SUPPORT
  get_value_from_cntrl_resource_conf_xml("CntrlModuleInfo", "TmrInfo", "MaxTmrNode", &uiCntrlTmrMaxNodeCnt_g);
  printf("\n Cntrl Maximum Timer Node allowed  = %u \r\n", uiCntrlTmrMaxNodeCnt_g);
#endif
