...
/** Additional nicira registers8,9 for firewall-nat application **/
#define NXM_NX_REG8       NXM_HEADER  (0x0001, 8, 8)
#define NXM_NX_REG8_W     NXM_HEADER_W(0x0001, 8, 8)
#define NXM_NX_REG9       NXM_HEADER  (0x0001, 9, 8)
#define NXM_NX_REG9_W     NXM_HEADER_W(0x0001, 9, 8)


#define FLOW_N_REGS 10
...
int32_t nicira_action_write_register(struct of_msg *msg, uint32_t index, uint64_t data, uint8_t offset, uint8_t n_bits);
#endif
