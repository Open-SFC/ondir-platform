...
#define CM_CLI_HORIZONTAL_SHOW_NEWLINE_DELIMITER ""
#define CM_CLI_SHOW_RECORD_DELIMITER	"\n\t"  //Modify this to modify the display as required
#define CM_CLI_HORIZONTAL_SHOW_RECORD_DELIMITER	", "  //Modify this to modify the display as required
#define CM_CLI_SHOW_TAB_START_DELIMITER "\n\t{"
#define CM_CLI_SHOW_TAB_END_DELIMITER	"\n\t}"
#define CM_CLI_HORIZONTAL_SHOW_TAB_START_DELIMITER "{"
#define CM_CLI_HORIZONTAL_SHOW_TAB_END_DELIMITER	" }"
...
int32_t cm_cli_display_record_with_arguments(char *dm_path_p, struct cm_cli_params * params_p, 
                               uint32_t param_cnt_ui, unsigned char is_table_b, unsigned char horizontal_display);
...
int32_t cm_cli_display_scalar_param_value (char * dm_path_p, char *param_name_p,
      struct cm_array_of_nv_pair *keys_array_p, unsigned char horizontal_display);
...
int32_t write_into_file(char *buff,  char *file_name);
...
struct cm_cli_cmd cm_cli_default_cmd_list[CM_CLI_MAX_CMD] = {
 ...
 " 4- CM_PERMISSION_READ_WRITE_ROLEPERM,\n\r",
  ...
  {"capture_data", 
   "Usage: capture_stats <table> <filename>  available records writes into a file.\n\r",
   FALSE,
   UCMCLI_SHOWCMD_PARAMCNT, cm_cli_show_params,
   (UCMCLIFUNPTR) cm_cli_write_records_into_file},
};
                               ...
                               struct cm_cli_params * params_p, uint32_t param_cnt_ui)
{
   ...
   else if(param_cnt_ui == 1) // 'help paramname'
   {
      CM_DLLQ_SCAN (&cli_session_p->current_node_p->data_elements_list, dll_q_node_p,UCMDllQNode_t *)
      {
         ...
         if (of_strcmp ((char *) params_p[0].param_value, (char *) data_ele_node_p->node_name) == 0)
         {
         ...
         CM_DLLQ_SCAN (&cli_session_p->current_node_p->child_list, dll_q_node_p,UCMDllQNode_t *)
         {
            ...
            if (of_strcmp ((char *) params_p[0].param_value, (char *) data_ele_node_p->node_name) == 0)
            {
                     ...
                     (data_ele_node_p->node_type == CM_DMNODE_TYPE_ANCHOR))
               {
                  ...
                  of_strcat(dmpath_a,".");
                  of_strcat(dmpath_a, (char *) data_ele_node_p->node_name);
                                     ...
                                     uint32_t param_cnt_ui)
{
            ...
            UCMDllQNode_t *)
      {
         ...
         if (param_cnt_ui == 1)
         {
            if (of_strcmp ((char *) params_p[0].param_value,
                     (char *) data_ele_node_p->node_name) == 0)
            {
               ...
               {
                  of_strcpy(tmp_opt_buff[tmp_attrib_cnt_i],(char *) data_ele_node_p->node_name); 
   ...
   if (( of_strcmp((char *) cli_session_p->current_node_p->node_name, "vsg") == 0) && (cli_session_p->current_node_p->node_type_ui == CM_DMNODE_TYPE_TABLE) && (cli_session_p->context_b == TRUE))
      goto end;
   CM_DLLQ_SCAN (&cli_session_p->current_node_p->child_list, dll_q_node_p, UCMDllQNode_t *)
   {
      data_ele_node_p = CM_DLLQ_LIST_MEMBER (dll_q_node_p,
      ...
      if( is_dir_back_b == TRUE)
      {
         ...
         else
         {
            ...
            for(i = 0; i < init_pos_i - cur_pos_i; i++)
            {
               ...
               uint8_t temp = cli_session_p->index_i;
               cli_session_p->index_i = temp--;
                       ...
                       uint32_t param_cnt_ui)
{
         ...
         UCMDllQNode_t *)
   {
      data_ele_node_p = CM_DLLQ_LIST_MEMBER (dll_q_node_p, struct cm_cli_data_ele_node *,
            list_node);
      if (of_strcmp ((char *) data_ele_node_p->node_name, (char *) params_p[0].param_value)
            == 0)
      {
         found_b = TRUE;
      }
   ...
   of_strcpy((char *) buff_a1, "-----END ");
   tmp_p = cert_buff_a; 
   while(1)
   {
      of_memset(buff_a2, 0, sizeof(buff_a2));
      cli_fgets(cli_session_p, (char *) buff_a2, PKI_GETS_BUFFER_LEN);
      if (of_strlen((char *) buff_a2) <= 0)
      {
         cm_cli_puts(cli_session_p," Invalid Certificate Data.\r\n");
         return OF_FAILURE;
      }

      l_length += of_strlen((char *) buff_a2);
      ...
      if(l_size < l_length)
      {
         ...
         tmp_p = cert_buff_a;
         tmp_p = tmp_p + l_length - of_strlen((char *) buff_a2);
      }

      of_strcpy((char *) tmp_p, (char *) buff_a2);

      if(of_strstr((char *) buff_a2, (char *) buff_a1) != NULL)
      {
         break;
      }

      tmp_p += of_strlen((char *) tmp_p);
      *tmp_p = '\n';
      tmp_p++;
      l_length++;
   }
   ...
   for (ii = 0, jj = 0; jj < nv_pair_array.count_ui; jj++)
   {
            ...
            UCMDllQNode_t *)
      {
         data_ele_node_p = CM_DLLQ_LIST_MEMBER (dll_q_node_p, struct cm_cli_data_ele_node *,
               list_node);
         if (of_strcmp ((char *) data_ele_node_p->node_name, tmp_nv_pair_p[jj].name_p) == 0)
         {
      ...
      tmp_nv_pair_p[jj].value_length = of_strlen ((char *) cert_buff_a);
                                   ...
                                   uint32_t param_cnt_ui)
{
   ...
   cm_cli_display_nv_pair(nv_pair_array_p->count_ui, nv_pair_array_p,NULL, FALSE, FALSE);
   cm_cli_puts (cli_session_p, "\n");
        cm_cli_puts (cli_session_p, "\n");
                       ...
                       struct cm_cli_params * params_p, uint32_t param_cnt_ui)
{
   ...
   if(nv_pair_array_p)
   { 
      cm_cli_display_nv_pair_array(nv_pair_array_p, 1,cli_session_p->dmpath_a, FALSE, FALSE);
      CM_FREE_PTR_NVPAIR_ARRAY(nv_pair_array_p, nv_pair_array_p->count_ui);
                                ...
                                struct cm_cli_params * params_p, uint32_t param_cnt_ui)
{
   ...
   {
      cm_cli_display_records_of_table (dmpath_a, &keys_array, TRUE, NULL, FALSE);
   }
   else
   {
      cm_cli_display_records_of_table (dmpath_a, &keys_array, FALSE, NULL, FALSE);
   }
   cm_cli_puts (cli_session_p, "\n\r");
                         ...
                         struct cm_cli_params * params_p, uint32_t param_cnt_ui)
{
   ...
   if (cm_dm_get_node_and_child_info (tmp_cli_session_p->tnsprt_channel_p,
            tmp_str_a, CM_CLI_MGMT_ENGINE_ID,
   ...
   if (node_info_p &&
         (node_info_p->element_attrib.element_type != CM_DMNODE_TYPE_TABLE))
   {
      sprintf (buff_a, "(%s) is not a table type to delete a record.\n\r", node_info_p->name_p);
      cm_cli_puts (cli_session_p, buff_a);
      if (node_info_p)
      {
...
int32_t cm_cli_display_record_with_arguments(char *dm_path_p, struct cm_cli_params * params_p, uint32_t param_cnt_ui,
                                             unsigned char is_table_b, unsigned char horizontal_display) 

{
   ...
   if(is_table_b == TRUE)
   {
      if (cm_cli_display_records_of_table (dm_path_p, &nv_pair_array, FALSE, NULL, horizontal_display) != OF_SUCCESS)
      {
         CM_FREE_NVPAIR_ARRAY (nv_pair_array, nv_pair_array.count_ui);
         return OF_FAILURE;
      }
   ...
   {
      if (cm_cli_display_records_of_scalar(dm_path_p,NULL, FALSE, NULL, is_table_b, 
                      &nv_pair_array, NULL, horizontal_display) == OF_SUCCESS)
      {
         CM_FREE_NVPAIR_ARRAY (nv_pair_array, nv_pair_array.count_ui);
         return OF_FAILURE;
      }
      ...
      struct cm_array_of_nv_pair *keys_array_p, unsigned char horizontal_display)
{
   ...
   //cm_cli_puts (cli_session_p, "\t{");
   if (horizontal_display == FALSE)
   {
     cm_cli_puts (cli_session_p, CM_CLI_SHOW_TAB_START_DELIMITER );
   }
   else
   {
     cm_cli_puts (cli_session_p, CM_CLI_HORIZONTAL_SHOW_TAB_START_DELIMITER);
   }
   cm_cli_display_nv_pair(temp_keys_array_p->count_ui, temp_keys_array_p,dm_path_p, NULL, horizontal_display);
//   cm_cli_puts (cli_session_p, CM_CLI_SHOW_RECORD_DELIMITER);
   ...
   {
      cm_cli_puts (cli_session_p, CM_CLI_HORIZONTAL_SHOW_TAB_END_DELIMITER);
      cm_cli_puts (cli_session_p, "\n");
      cm_cli_puts (cli_session_p, "\n");
   }
   //cm_cli_puts (cli_session_p, "\n\r");
                              ...
                              struct cm_cli_params * params_p, uint32_t param_cnt_ui)
{
   int32_t return_value = OF_FAILURE;
   UCMDllQNode_t *dll_q_node_p;
   struct cm_cli_data_ele_node *data_ele_node_p = NULL, *child_node_p;
   struct cm_cli_session *tmp_cli_session_p;
   struct cm_array_of_nv_pair keys_array = {0};
   ...
   int32_t  ii;
   char *tmp_dm_path_p = NULL;
   unsigned char parent_is_table_p = FALSE, horizontal_display = FALSE;
   ...
   else if (param_cnt_ui == 2)
   {
      ...
      if (strcmp(param_a2,"horizontal")==0)
        horizontal_display = TRUE;
   }
   else if (param_cnt_ui >= 3)
   {
      of_strcpy (param_a1, (char *) params_p[0].param_value);
      of_strcpy (param_a2, (char *) params_p[1].param_value);
      if (strcmp((char *) params_p[2].param_value,"horizontal")==0)
         horizontal_display = TRUE;
   }
                  ...
                  (tmp_node_info_p->element_attrib.element_type == CM_DMNODE_TYPE_SCALAR_VAR))
            {
                     ...
                     && (of_strcmp(tmp_node_info_p->element_attrib.cli_identifier_p, param_a1) == 0))
               {
                  if(cm_cli_display_records_of_scalar(tmp_dmpath_a,params_p,TRUE,
                           tmp_node_info_p->name_p, parent_is_table_p,NULL, NULL,
                           horizontal_display)==OF_SUCCESS)
                  {
                     return OF_SUCCESS;
                  }
                  else
               ...
               {
                  if(cm_cli_display_records_of_scalar(tmp_dmpath_a,params_p,FALSE,NULL,
                                          parent_is_table_p,NULL, NULL, horizontal_display)==OF_SUCCESS)
                  {
                     return OF_SUCCESS;
                  }
                  else
            ...
            if (tmp_node_info_p->element_attrib.element_type == CM_DMNODE_TYPE_ANCHOR)
            {
               if(tmp_node_info_p->element_attrib.scalar_group_b == TRUE)
               {
                  if(param_cnt_ui == 1 || param_cnt_ui%2 == 1)
                  {
                     ...
                     if (param_cnt_ui != 1)
                     {
                        if(cm_cli_display_record_with_arguments(dmpath_a,params_p,param_cnt_ui,FALSE, horizontal_display) != OF_SUCCESS)
                        {
                           return OF_FAILURE;
                        }
                     }
                     ...
                     {
                        if (cm_cli_display_records_of_scalar(dmpath_a,NULL, FALSE, NULL, parent_is_table_p,
                                                NULL, NULL, horizontal_display) == OF_SUCCESS)
                        {
                           return OF_SUCCESS;
                        }
                        else
               ...
               {
                  cm_cli_puts (cli_session_p, " No records to display at this level.\n\r");
                  return OF_FAILURE;
               }
            }
            break;
      ...
      case CM_DMNODE_TYPE_ANCHOR:
         {
            ...
            else if ((param_cnt_ui == 1) || ((param_cnt_ui == 2) && (horizontal_display == TRUE)))
            {
                     ...
                     UCMDllQNode_t *)
               {
                  ...
                  if (of_strcmp (param_a1, (char *) data_ele_node_p->node_name) == 0)
                  {
                     ...
                     if(sca_grp_b !=TRUE)
                     {
                        ...
                        cm_cli_display_records_of_scalar(dmpath_a,NULL, FALSE, NULL, parent_is_table_p,NULL, 
                                                       NULL,horizontal_display);
                        break;
                     }
                     else
                     {
                        of_strcpy (dmpath_a, tmp_cli_session_p->dmpath_a);
                        return_value = cm_cli_display_records_of_scalar(dmpath_a,params_p,FALSE,NULL,
                                                     parent_is_table_p,NULL, NULL,horizontal_display);
                        break;
                     }
                  }
               }
                     ...
                     UCMDllQNode_t *)
               {
                  ...
                  if (of_strcmp (param_a1, (char *) data_ele_node_p->node_name) == 0)
                  {
                     ...
                     of_strcat (dmpath_a, ".");
                     of_strcat (dmpath_a, param_a1);
                     if ((cm_cli_display_records_of_table (dmpath_a, &keys_array, FALSE, NULL, horizontal_display)) == OF_SUCCESS)
                     {
                        return OF_SUCCESS;
                     }
                     else
            ...
            else if (((param_cnt_ui == 2) && (horizontal_display == FALSE)) || (param_cnt_ui > 2))
            {
                     ...
                     UCMDllQNode_t *)
               {
                  ...
                  if (of_strcmp (param_a1, (char *) data_ele_node_p->node_name) == 0)
                  {
                     ...
                     if (cm_cli_display_records_of_table (dmpath_a, keys_array_p, TRUE, NULL, horizontal_display) == OF_SUCCESS)
                     {
                        return OF_SUCCESS;
                     }
                     break;
            ...
            else
            {
                     ...
                     UCMDllQNode_t *)
               {
                  ...
                  if (of_strcmp (param_a1, (char *) data_ele_node_p->node_name) == 0)
                  {
                     ...
                     of_strcat (dmpath_a, ".");
                     of_strcat (dmpath_a, param_a1);
                     if(cm_cli_display_record_with_arguments(dmpath_a,params_p,param_cnt_ui,TRUE, horizontal_display) != OF_SUCCESS)
                     {
                        return OF_FAILURE;
                     }
      ...
      case CM_DMNODE_TYPE_TABLE:
         {
            ...
            if (!(param_cnt_ui))
            {
               ...
               {
                  if (cm_cli_display_records_of_table (dmpath_a, &keys_array, TRUE, NULL, horizontal_display) == OF_SUCCESS)
                  {
                     return OF_SUCCESS;
                  }
               }
               ...
               {
                  //if (cm_cli_display_records_of_table (dmpath_a, &keys_array, FALSE, FALSE) == OF_SUCCESS)
                  len_ui = of_strlen(tmp_cli_session_p->context_path);
                  if(len_ui > 0 && tmp_cli_session_p->context_path[len_ui-1] == '}')
                  {
                     if (cm_cli_display_records_of_table (tmp_cli_session_p->context_path, &keys_array, TRUE, NULL, horizontal_display) == OF_SUCCESS)
                     {
                        return OF_SUCCESS;
                     }
                  }
            ...
            else if ((param_cnt_ui == 1) || ((param_cnt_ui == 2) && (horizontal_display == TRUE)))
            {
               if (tmp_cli_session_p->context_b)
               {
                        ...
                        UCMDllQNode_t *)
                  {
                     child_node_p =
                        CM_DLLQ_LIST_MEMBER (dll_q_node_p, struct cm_cli_data_ele_node *,
                              list_node);
                     if (of_strcmp (param_a1, (char *) child_node_p->node_name) == 0)
                     {
                        cm_cli_get_dir_path (dir_path_a);
                        cm_cli_convert_dir_to_dmpath (dir_path_a, dmpath_a);
                        of_strcat(dmpath_a, ".");
                        of_strcat(dmpath_a, (char *) child_node_p->node_name);
               ...
               else
               {
                  ...
                  else
                  {
                     ...
                     of_strcat (dmpath_a, param_a1);
                     of_strcat (dmpath_a, "}");
                     if (cm_cli_display_records_of_table (dmpath_a, &keys_array, TRUE, FALSE) == OF_SUCCESS)
                     {
                        return OF_SUCCESS;
                     }
#endif 
                            ...
                            struct cm_cli_params * params_p, uint32_t param_cnt_ui)
{
   ...
   if(return_value == OF_SUCCESS)
   {
      cm_cli_display_nv_pair_array (out_array_of_nv_pair_arr, rec_count_ui,dmpath_a, FALSE, TRUE);
      cm_cli_free_node_info(node_info_p);
      cm_cli_cleanup_array_of_node_info(child_info_arr_p);
      return OF_SUCCESS;
   }
                                    ...
                                    int32_t param_cnt_i)
{
   ...
   if(param_cnt_i == 1)
   {
      cm_cli_display_records_of_table (dmpath_a, &nv_pair_array, FALSE, NULL, FALSE);
   }
   else
   {
                                         ...
                                         int32_t param_cnt_i)
{
   ...
   {
      sprintf(buff_a," Invalid input. Total length of the input should be less than %ld\r\n", (sizeof(temp_path_a) - of_strlen(temp_path_a)) );
      cm_cli_puts(cli_session_p, buff_a);
      return OF_FAILURE;
   }
   of_strcat (temp_path_a,(char *) params_p[0].param_value);
   ...
   if (return_value1==OF_SUCCESS)
   {
      ...
      if(prompt_len_ui > sizeof(temp_path_a))
      {
         sprintf(buff_a," Invalid input. Total length of key value parameters should be less than %ld\r\n", (sizeof(temp_path_a) - of_strlen(temp_path_a)) );
         cm_cli_puts(cli_session_p, buff_a);
   ...
   CM_DLLQ_SCAN (&cli_session_p->current_node_p->data_elements_list, dll_q_node_p, UCMDllQNode_t *)
   {
      data_ele_node_p = CM_DLLQ_LIST_MEMBER (dll_q_node_p,struct cm_cli_data_ele_node *, list_node);
      {
         if((data_ele_node_p->mandatory_b == TRUE) && (data_ele_node_p->key_b == FALSE))
         {
            ...
            {
               found_b = TRUE;
               param_len_ui = of_strlen((char *) data_ele_node_p->node_name);
               ...
               of_strcpy(name_p, (char *) data_ele_node_p->node_name);
                                         ...
                                         uint32_t param_cnt_ui)
{
   ...
   for (ii = 0, jj = 0; jj < nv_pair_array.count_ui; jj++)
   {
            ...
            UCMDllQNode_t *)
      {
         data_ele_node_p = CM_DLLQ_LIST_MEMBER (dll_q_node_p, struct cm_cli_data_ele_node *,
               list_node);
         if (of_strcmp ((char *) data_ele_node_p->node_name, (char *) params_p[ii].param_value) == 0)
         {      
            found_b = TRUE;
         }
         ...
         {
            /* Copy Name Len */
            tmp_nv_pair_p[jj].name_length = of_strlen ((char *) data_ele_node_p->node_name);
                                         ...
                                         uint32_t param_cnt_ui)
{
   ...
   for (ii = 0; ii < param_cnt_ui; ii += 2)
   {
            ...
            UCMDllQNode_t *)
      {
         data_ele_node_p = CM_DLLQ_LIST_MEMBER (dll_q_node_p, struct cm_cli_data_ele_node *,
               list_node);
         if( (of_strcmp ((char *) data_ele_node_p->node_name, (char *) params_p[ii].param_value) == 0) || (data_ele_node_p->cli_identifier_p != NULL &&  (of_strcmp (data_ele_node_p->cli_identifier_p, (char *) params_p[ii].param_value) == 0)) )
         {
      ...
      if(sca_grp_b != TRUE)
      {
         ...
         of_strcat (temp_path_a,".");
         of_strcat (temp_path_a, (char *) data_ele_node_p->node_name);
      ...
      nv_pair.name_length = of_strlen ((char *) data_ele_node_p->node_name);
      nv_pair.name_p = (char *) of_calloc (1, nv_pair.name_length + 1);
      if (nv_pair.name_p == NULL)
      {
         cm_cli_puts (cli_session_p, " Calloc failed.\n\r");
...
int32_t cm_cli_context_help (void)
{
   ...
   char tmp_opt_buff[MAX_A_BUFF_SIZE][MAX_A_BUFF_SIZE];
   char tmp_mand_buff[64][MAX_A_BUFF_SIZE];
   unsigned char opt_param_b = FALSE, mand_param_b = FALSE, config_b = FALSE;
   char tmp_buff_a[CM_CLI_MAX_PROMPT_LEN];
   ...
   if ((of_strcmp((char *) cli_session_p->current_node_p->node_name, "vsg") == 0) && (cli_session_p->current_node_p->node_type_ui == CM_DMNODE_TYPE_TABLE) && (cli_session_p->context_b))
   {
      return OF_SUCCESS;
   }
            ...
            switch (tmp_node_info_p->data_attrib.attrib_type)
            {
               ...
               case CM_DATA_ATTRIB_INT64_RANGE:
                  sprintf (buff_a, " [ %ld to %ld ]",
                        (long int) tmp_node_info_p->data_attrib.attr.longint_range.start_value,
                        (long int) tmp_node_info_p->data_attrib.attr.longint_range.end_value);
                  of_strcat(tmp_buff_a,buff_a);
                  break;
               case CM_DATA_ATTRIB_UINT64_RANGE:
                  sprintf (buff_a, " [ %d to %d ]",
                        (int ) tmp_node_info_p->data_attrib.attr.ulongint_range.start_value,
                        (int ) tmp_node_info_p->data_attrib.attr.ulongint_range.end_value);
                  of_strcat(tmp_buff_a,buff_a);
                  break;
               case CM_DATA_ATTRIB_INT64_ENUM:
                  ...
                  {
                     sprintf (buff_a, "%ld",
                           (long int) tmp_node_info_p->data_attrib.attr.longint_enum.array[cnt_ui]);
                     if(cnt_ui > 0)
                        of_strcat(tmp_buff_a, CM_CLI_ENUM_SEPERATOR);
                     of_strcat(tmp_buff_a, buff_a);
                  }
               ...
               case CM_DATA_ATTRIB_UINT64_ENUM:
                  ...
                  {
                     sprintf (buff_a, "%u",
                           (unsigned int) tmp_node_info_p->data_attrib.attr.ulongint_enum.array[cnt_ui]);
                     if(cnt_ui > 0)
                        of_strcat(tmp_buff_a, CM_CLI_ENUM_SEPERATOR);
                     of_strcat(tmp_buff_a,buff_a);
                  }
...
{
   uint16_t ii, jj, kk, token_len_ui, len_ui = 0, match_count_ui = 0,
            min_length = 0, min_index_ui = 0, cmd_len_ui = 0, start_i = 0, glb_end_pos_ui = 0;
   ...
   UCMDllQNode_t *dll_q_node_p;
   struct cm_cli_data_ele_node* data_ele_node_p;
   unsigned char tab_b = FALSE, glb_cmd_b = FALSE, cmd_b = FALSE;
   ...
   if((token_len_ui > 0) && (tab_b == TRUE)) //Auto completion, Ex: acctsrvr 1.1.1.1 sh<tab>
   {
      if(cmd_b == TRUE)
      {
         CM_DLLQ_SCAN (&tmp_cli_session_p->current_node_p->child_list, dll_q_node_p,UCMDllQNode_t *)
         {
            ...
            if (of_strcmp (token_a, (char *) data_ele_node_p->node_name) == 0)
            {
               if (data_ele_node_p->node_type == CM_DMNODE_TYPE_TABLE)
               {
      ...
      else if(tab_cnt_ui > 0)  //Ex: acctsrvr 1.1.1.1 <tab>
      {
         CM_DLLQ_SCAN (&cli_session_p->current_node_p->child_list, dll_q_node_p,UCMDllQNode_t *)
         {
            ...
            if (of_strcmp ((char *) data_ele_node_p->node_name, (char *)token_a) == 0)
            {
               if (data_ele_node_p->node_type == CM_DMNODE_TYPE_TABLE)
               {
                  parent_trans_b = data_ele_node_p->parent_trans_b;
...
int32_t cm_cli_display_table_help (void * tnsprt_channel_p,
           ...
           unsigned char is_vsg_table_b)
{
   struct cm_dm_node_info *node_info_p = NULL, *tmp_node_info_p, *tmp_node_info_arr_p = NULL;
      ...
      if(tmp_node_info_p != NULL)
      {
         ...
         if(tmp_node_info_p->element_attrib.element_type == CM_DMNODE_TYPE_SCALAR_VAR && tmp_node_info_p->element_attrib.visible_b == TRUE)
         {
            ...
            switch (tmp_node_info_p->data_attrib.attrib_type)
            {
               ...
               case CM_DATA_ATTRIB_UINT64_RANGE:
                  sprintf (buff_a, " [ %ld to %ld ]",
                        (long int) tmp_node_info_p->data_attrib.attr.ulongint_range.start_value,
                        (long int) tmp_node_info_p->data_attrib.attr.ulongint_range.end_value);
                  of_strcat(tmp_buff_a,buff_a);
                  break;
               case CM_DATA_ATTRIB_INT64_ENUM:
                  of_strcat(tmp_buff_a," { ");
               ...
               case CM_DATA_ATTRIB_UINT64_ENUM:
                  ...
                  {
                     sprintf (buff_a, "%lu",
                           (long unsigned int) tmp_node_info_p->data_attrib.attr.ulongint_enum.array[cnt_ui]);
                     if(cnt_ui > 0)
                        of_strcat(tmp_buff_a, CM_CLI_ENUM_SEPERATOR);
                     of_strcat(tmp_buff_a,buff_a);
                  }
            ...
            UCMDllQNode_t *)
      {
         ...
         if (data_ele_node_p->node_type == CM_DMNODE_TYPE_TABLE)
         {
            ...
            if (return_value == OF_SUCCESS)
            {
               if (count_ui)
               {
/* Instance are getting displayed from Instance tree(local tree), not from
security applications. this feature is for developer debugging only. if 
require, we will enable this later */
#if 0
                  found_b = TRUE;
                  cm_cli_puts (cli_session_p, "\n\t***********************************");
            ...
            UCMDllQNode_t *)
      {
         ...
         if (data_ele_node_p->node_type == CM_DMNODE_TYPE_SCALAR_VAR)
         {
            ...
            of_strcat (dmpath_a, ".");
            of_strcat (dmpath_a, (char *) data_ele_node_p->node_name);
            cm_cli_display_records_of_scalar(dmpath_a,NULL,FALSE,NULL,FALSE,NULL, NULL, FALSE);
         }
      }
   }
   else
   {
      ...
      else
      {
               ...
               UCMDllQNode_t *)
         {
            data_ele_node_p = CM_DLLQ_LIST_MEMBER (dll_q_node_p, struct cm_cli_data_ele_node *,
                  list_node);
            if( (of_strcmp((char *) data_ele_node_p->node_name, table_name_a_g) == 0) && (data_ele_node_p->node_type == CM_DMNODE_TYPE_TABLE) )
            {
               parent_trans_b = data_ele_node_p->parent_trans_b;
                                   ...
                                   char* file_name, unsigned char horizontal_display)
{
   ...
   {
      if ((horizontal_display == FALSE) &&  (file_name == NULL))
        cm_cli_puts (cli_session_p, CM_CLI_SHOW_TAB_START_DELIMITER );
      else if ((file_name == NULL) && (horizontal_display == TRUE))
        cm_cli_puts (cli_session_p, CM_CLI_HORIZONTAL_SHOW_TAB_START_DELIMITER );
      ...
      {
        cm_cli_puts (cli_session_p, CM_CLI_HORIZONTAL_SHOW_TAB_END_DELIMITER );
        cm_cli_puts (cli_session_p, CM_CLI_HORIZONTAL_SHOW_RECORD_DELIMITER);
        cm_cli_puts (cli_session_p, "\n");
        cm_cli_puts (cli_session_p, "\n");
      }
     if (file_name == NULL)
 ...
 * Return value  : none
 ***************************************************************************/
void cm_cli_display_nv_pair(uint32_t count_ui, struct cm_array_of_nv_pair *nv_pair_array_p,
                           char * dm_path_p, char* file_name, unsigned char horizontal_display)
{
   uint32_t  max_buf_ui= 10240;
   int32_t ii=0;
   char buff_a[max_buf_ui];
   char buff_a1[max_buf_ui];
   char *name_p = NULL;
   char *identifier_p = NULL;


   of_memset(buff_a1, 0, sizeof(buff_a1));
   strcat(buff_a1, "\n");
   for (ii = 0; ii < nv_pair_array_p->count_ui; ii++)
   {
      if(ii == 0)
      {
        if ((file_name == NULL) && (horizontal_display == FALSE))
          cm_cli_puts (cli_session_p, CM_CLI_SHOW_NEWLINE_DELIMITER);
        else if (horizontal_display == FALSE)
          strcat(buff_a1, "\n");
        else if ((horizontal_display == TRUE) && (file_name != NULL))
          cm_cli_puts (cli_session_p, CM_CLI_HORIZONTAL_SHOW_NEWLINE_DELIMITER);
      }
      else
      {
        if ((file_name == NULL) && (horizontal_display == FALSE))
          ...
          strcat(buff_a1, ", ");
        else if (horizontal_display == TRUE)
          cm_cli_puts (cli_session_p, CM_CLI_HORIZONTAL_SHOW_RECORD_DELIMITER);
        //cm_cli_puts (cli_session_p, "\n");
      }
      of_memset(buff_a, 0, sizeof(buff_a));
...
//      cm_cli_puts (cli_session_p, CM_CLI_SHOW_DELIMITER);
      ...
      if (file_name != NULL)
      {
         write_into_file(buff_a1, file_name);
         of_memset(buff_a1, 0, sizeof(buff_a1));
      }
}
...
int32_t cm_cli_display_records_of_table (char * dm_path_p,
      struct cm_array_of_nv_pair *keys_array_p,
      unsigned char exact_b, char* file_name, unsigned char horizontal_display)
{
   struct cm_cli_session *tmp_cli_session_p = cli_session_p;
   ...
   if (exact_b)
   {
      ...
      cm_cli_display_nv_pair_array (out_nv_pair_array_p, 1,dm_path_p, FALSE, horizontal_display);
      ...
      else
      {
         for (ii = 0; ii < child_info_arr_p->count_ui; ii++)
         {
            ...
            if (tmp_node_info_p->element_attrib.element_type == CM_DMNODE_TYPE_TABLE)
            {
               ...
               cm_cli_display_records_of_table (dmpath_a, keys_array_p, FALSE, file_name, horizontal_display);
               continue;
            }
                  ...
                  tmp_node_info_p->element_attrib.element_type == CM_DMNODE_TYPE_ANCHOR)
            {
               ...
               if(tmp_node_info_p->element_attrib.scalar_group_b == TRUE)
               {
                  cm_cli_display_records_of_scalar(dmpath_a,NULL,FALSE,NULL,FALSE,NULL, NULL, horizontal_display);
               }
               cm_cli_display_records_of_table (dmpath_a, keys_array_p, FALSE, file_name, horizontal_display);
               continue;
            }             
   ...
   else
   {
      if(table_b == TRUE)
      {
         ...
         /* Display the received information */
         cm_cli_display_nv_pair_array (out_nv_pair_array_p, count_ui,dm_path_p, file_name, horizontal_display);
                  ...
                  node_info_p->element_attrib.parent_trans_b == TRUE))
         {
            ...
            for (ii = 0; ii < child_info_arr_p->count_ui; ii++)
            {
               ...
               if (tmp_node_info_p->element_attrib.element_type == CM_DMNODE_TYPE_TABLE)
               {
                  ...
                  cm_cli_display_records_of_table (tmp_dmpath_a, keys_array_p, FALSE, file_name, horizontal_display);
                  continue;
               }
               if(tmp_node_info_p->element_attrib.parent_trans_b == TRUE &&
                     tmp_node_info_p->element_attrib.element_type == CM_DMNODE_TYPE_ANCHOR)
               {
                  ...
                  if(tmp_node_info_p->element_attrib.scalar_group_b == TRUE)
                  {
                     cm_cli_display_records_of_scalar(tmp_dmpath_a,NULL,FALSE,NULL, FALSE,NULL, NULL, horizontal_display);
                  }
                  cm_cli_display_records_of_table (tmp_dmpath_a, keys_array_p, FALSE, file_name, horizontal_display);
                  continue;
               }
   ...
   if(params_p != NULL)
   {
      for(ii = 0; ii < out_nv_pair_array_p->count_ui; ii++)
      {
         if(of_strcmp(param_a, out_nv_pair_array_p->nv_pairs[ii].name_p) ==0)
         {
            ...
            cm_cli_display_nv_pair(nv_pairs_array.count_ui, &nv_pairs_array,dm_path_p, FALSE, horizontal_display);
            if (horizontal_display == FALSE)
            {
      	      cm_cli_puts (cli_session_p, CM_CLI_SHOW_TAB_END_DELIMITER );
            }
                              ...
                              struct cm_cli_params * params_p, uint32_t param_cnt_ui)
{
   ...
   struct cm_array_of_nv_pair keys_array = {0};
   struct cm_array_of_nv_pair *keys_array_p = NULL;
   char param_a1[CM_CLI_MAX_NAME_LEN + 1],param_a2[CM_CLI_MAX_NAME_LEN + 1]={}, file_name[CM_CLI_MAX_NAME_LEN];
   char dir_path_a[CM_CLI_MAX_PROMPT_LEN + 1], dmpath_a[CM_CLI_MAX_PROMPT_LEN + 1];
   char tmp_dmpath_a[CM_CLI_MAX_PROMPT_LEN + 1];
   uint32_t len_ui = 0;
   struct cm_dm_node_info *node_info_p=NULL;
   ...
   of_memset (param_a1, 0, sizeof (param_a1));
   of_memset (param_a2, 0, sizeof (param_a2));
   of_memset (file_name, 0, sizeof (file_name));

   if (param_cnt_ui == 1)
   {
      cm_cli_puts (cli_session_p, " Invalid input.Syntax is \'capture_data <tablename> <filename>\'\n\r");
      return OF_FAILURE;
   }
   else if (param_cnt_ui == 2)
   {
      of_strcpy (param_a1, (char *) params_p[0].param_value);
      of_strcpy (file_name, (char *) params_p[1].param_value);
   }
   else if (param_cnt_ui >= 3)
   {
      of_strcpy (param_a1, (char *) params_p[0].param_value);
      of_strcpy (param_a2, (char *) params_p[1].param_value);
      of_strcpy (file_name, (char *) params_p[2].param_value);
   }
      ...
      for (index_i = 0; index_i < child_info_arr_p->count_ui; index_i++)
      {
                ...
                && (of_strcmp(tmp_node_info_p->element_attrib.cli_identifier_p, param_a1) == 0)) )
         {
                  ...
                  (tmp_node_info_p->element_attrib.element_type == CM_DMNODE_TYPE_SCALAR_VAR))
            {
               ...
               {
                  if(cm_cli_display_records_of_scalar(tmp_dmpath_a,params_p,TRUE,
                           tmp_node_info_p->name_p, parent_is_table_p,NULL, file_name, horizontal_display)==OF_SUCCESS)
                  {
                     return OF_SUCCESS;
                  }
                  else
               ...
               {
                  if(cm_cli_display_records_of_scalar(tmp_dmpath_a,params_p,FALSE,NULL,
                                 parent_is_table_p,NULL, file_name, horizontal_display)==OF_SUCCESS)
                  {
                     return OF_SUCCESS;
                  }
                  else
            ...
            if (tmp_node_info_p->element_attrib.element_type == CM_DMNODE_TYPE_ANCHOR)
            {
               if(tmp_node_info_p->element_attrib.scalar_group_b == TRUE)
               {
                  if(param_cnt_ui == 2 || param_cnt_ui%2 == 1)
                  {
                     if(tmp_cli_session_p->context_b)
                     {
                        cm_cli_get_dir_path (dir_path_a);
                     ...
                     {
                        if (cm_cli_display_records_of_scalar(dmpath_a,NULL, FALSE, NULL, 
                                            parent_is_table_p,NULL, file_name, horizontal_display) == OF_SUCCESS)
                        {
                           return OF_SUCCESS;
                        }
            ...
            else if (param_cnt_ui == 2)
            {
                     ...
                     UCMDllQNode_t *)
               {
                  ...
                  if (of_strcmp (param_a1, (char *) data_ele_node_p->node_name) == 0)
                  {
                     ...
                     if(sca_grp_b !=TRUE)
                     {
                        ...
                        of_strcat (dmpath_a, ".");
                        of_strcat (dmpath_a, (char *) data_ele_node_p->node_name);
                        cm_cli_display_records_of_scalar(dmpath_a,NULL, FALSE, NULL, 
                                      parent_is_table_p,NULL, file_name, horizontal_display);
                        break;
                     }
                     else
                     {
                     ...
                     UCMDllQNode_t *)
               {
                  ...
                  if (of_strcmp (param_a1, (char *) data_ele_node_p->node_name) == 0)
                  {
                     ...
                     of_strcat (dmpath_a, ".");
                     of_strcat (dmpath_a, param_a1);
                     if ((cm_cli_display_records_of_table (dmpath_a, &keys_array, FALSE, file_name, 
                                      horizontal_display)) == OF_SUCCESS)
                     {
                        return OF_SUCCESS;
                     }
            ...
            else if (param_cnt_ui == 3)
            {
                     ...
                     UCMDllQNode_t *)
               {
                  ...
                  if (of_strcmp (param_a1, (char *) data_ele_node_p->node_name) == 0)
                  {
                     ...
                     if (cm_cli_display_records_of_table (dmpath_a, keys_array_p, TRUE, file_name, horizontal_display) == OF_SUCCESS)
                     {
                        return OF_SUCCESS;
                     }
                     break;
      ...
      case CM_DMNODE_TYPE_TABLE:
         {
            ...
            if (!(param_cnt_ui))
            {
               ...
               if(len_ui > 0 && dmpath_a[len_ui - 1] == '}')
               {
                  if (cm_cli_display_records_of_table (dmpath_a, &keys_array, TRUE, file_name, horizontal_display) == OF_SUCCESS)
                  {
                     return OF_SUCCESS;
                  }
               }
               else
               {
                  ...
                  if(len_ui > 0 && tmp_cli_session_p->context_path[len_ui-1] == '}')
                  {
                     if (cm_cli_display_records_of_table (tmp_cli_session_p->context_path, &keys_array, 
                                            TRUE, file_name, horizontal_display) == OF_SUCCESS)
                     {
                        return OF_SUCCESS;
                     }
                  }
                  ...
                  {
                     if (cm_cli_display_records_of_table (dmpath_a, &keys_array, FALSE, file_name, horizontal_display) == OF_SUCCESS)
                     {
                        return OF_SUCCESS;
                     }
                  }
               ...
               if (tmp_cli_session_p->context_b)
               {
                        ...
                        UCMDllQNode_t *)
                  {
                     ...
                     if (of_strcmp (param_a1, (char *) child_node_p->node_name) == 0)
                     {
                        ...
                        if (cm_cli_display_records_of_table (dmpath_a, &keys_array, FALSE, param_a2, horizontal_display) == OF_SUCCESS)
                        {
                           return OF_SUCCESS;
                        }
                     }
...
int32_t write_into_file(char *buff, char *file_name)
{
  ...
  if (buff == NULL)
  {
    printf (" \r\nInvalid parameters. Nothing to write into file");
    return OF_FAILURE;
  }
#ifdef OF_CM_CNTRL_SUPPORT 
  strcat(pFullPath, "/ondirector/debug/");
#endif
#ifdef OF_CM_SWITCH_CBK_SUPPORT 
  strcat(pFullPath, "/psp/debug/");
#endif
  if (file_name != NULL )
    strcat(pFullPath, file_name);
  else
    strcat(pFullPath, "stats");
  ...
  iRet = cm_file_write (iDestFd, iDestFd, (unsigned char *) buff, strlen(buff));
  if (iRet == -1)
  {
    printf ("ERROR writing data into a file.");
  }
