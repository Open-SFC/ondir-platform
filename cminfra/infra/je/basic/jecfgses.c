      ...
      struct cm_result * result_p)
{
   ...
   dm_path_p = (char *) config_request_p->dm_path_p;
   ...
   if ((return_value = je_validate_command (config_request_p->sub_command_id, 
            (char *) config_request_p->dm_path_p,
   ...
   switch (config_request_p->sub_command_id)
   {
      ...
      case CM_CMD_SET_PARAMS:
               ...
               UCMDllQNode_t *)
         {
            command_list_p =
               CM_DLLQ_LIST_MEMBER (pDllQNode, struct je_command_list *, list_node);
            if (!strcmp (command_list_p->command_p->dm_path_p, (char *) config_request_p->dm_path_p))
            {
               if (je_cfgsess_add_to_exist_commandlist (command_list_p, config_request_p) !=
                     OF_SUCCESS)
               {
      ...
      case CM_CMD_CANCEL_PREV_CMD:
               ...
               UCMDllQNode_t *)
         {
            command_list_p =
               CM_DLLQ_LIST_MEMBER (pDllQNode, struct je_command_list *, list_node);
            if (!of_strcmp (command_list_p->command_p->dm_path_p, (char *) config_request_p->dm_path_p))
            {
               for (uiNvCnt = 0;
      ...
      case CM_CMD_SET_PARAM_TO_DEFAULT:
         ...
         if (je_set_nvpair_array_to_default_values
               ((char *) config_request_p->dm_path_p, &(config_request_p->data.nv_pair_array), result_p)
               != OF_SUCCESS)
         {
 ...
 int32_t DelInstances(struct je_config_session *config_session_p,struct cm_result * result_p)
{
   ...
   CM_DLLQ_SCAN(&(UCMJEGloTransaction_g), xtn_entry_p, struct je_xtn_entry*)
   {
      ...
      {
         cm_get_channel_id_and_appl_id (dm_path_p, &appl_id_ui, &channel_id_ui);
         pEndFn = cm_channels_p[channel_id_ui]->cm_end_xtn;
      ...
      config_request_p)
{
   ...
   of_strncpy ((char *) pConfigSess->admin_role, (char *) config_request_p->admin_role,
         CM_MAX_ADMINROLE_LEN);
   of_strncpy ((char *) pConfigSess->admin_name, (char *) config_request_p->admin_name,
      ...
      struct cm_result * result_p)
{
   ...
   switch (attrib_p->data_attrib.data_type)
   {
      ...
      case CM_DATA_TYPE_UINT:
         ...
         sprintf(value_p,"%ld",(long int) uiValNum);
         of_free(pNvPair->value_p);
         pNvPair->value_p = value_p;
         break;
      ...
      case CM_DATA_TYPE_INT64:
         ...
         sprintf(value_p,"%ld",(long int) iValNum);
         of_free(pNvPair->value_p);
         pNvPair->value_p = value_p;
   ...
   switch (attrib_p->data_attrib.attrib_type)
   {
      ...
      case CM_DATA_ATTRIB_UINT_RANGE:
               ...
               (uiValNum > attrib_p->data_attrib.attr.uint_range.end_value))
         {
            ...
            sprintf (result_p->result.error.result_string_p,
                  ...
                  (long int) attrib_p->data_attrib.attr.uint_range.start_value,
                  (long int) attrib_p->data_attrib.attr.uint_range.end_value);
            goto ErrorHandler;
         }
         break;
      ...
      case CM_DATA_ATTRIB_UINT_ENUM:
         ...
         if (bMatchFound == FALSE)
         {
                  ...
                  uiCnt++)
            {
               of_memset (aTmpBuf, 0, sizeof (aTmpBuf));
               sprintf (aTmpBuf, "%ld, ",
                     (long int) attrib_p->data_attrib.attr.uint_enum.array[uiCnt]);
               of_strncat (result_p->result.error.result_string_p, aTmpBuf,
                     of_strlen (aTmpBuf));
            }
            goto ErrorHandler;
      ...
      case CM_DATA_ATTRIB_INT64_RANGE:
               ...
               (iValNum > attrib_p->data_attrib.attr.longint_range.end_value))
         {
            ...
            sprintf (result_p->result.error.result_string_p,
                  "Element Value must be in between %ld and %ld",
                  (long int) attrib_p->data_attrib.attr.longint_range.start_value,
                  (long int) attrib_p->data_attrib.attr.longint_range.end_value);
            goto ErrorHandler;
         }
         break;
      case CM_DATA_ATTRIB_UINT64_RANGE:
               ...
               (uiValNum > attrib_p->data_attrib.attr.ulongint_range.end_value))
         {
            ...
            sprintf (result_p->result.error.result_string_p,
                  "Element Value must be in between %ld and %ld",
                  (long int) attrib_p->data_attrib.attr.ulongint_range.start_value,
                  (long int) attrib_p->data_attrib.attr.ulongint_range.end_value);
            goto ErrorHandler;
         }
         break;
      case CM_DATA_ATTRIB_INT64_ENUM:
         ...
         if (bMatchFound == FALSE)
         {
                  ...
                  uiCnt++)
            {
               of_memset (aTmpBuf, 0, sizeof (aTmpBuf));
               sprintf (aTmpBuf, "%ld, ",
                     (long int) attrib_p->data_attrib.attr.longint_enum.array[uiCnt]);
               of_strncat (result_p->result.error.result_string_p, aTmpBuf,
                     of_strlen (aTmpBuf));
            }
            goto ErrorHandler;
      ...
      case CM_DATA_ATTRIB_UINT64_ENUM:
         ...
         if (bMatchFound == FALSE)
         {
                  ...
                  uiCnt++)
            {
               of_memset (aTmpBuf, 0, sizeof (aTmpBuf));
               sprintf (aTmpBuf, "%ld, ",
                     (long int) attrib_p->data_attrib.attr.ulongint_enum.array[uiCnt]);
               of_strncat (result_p->result.error.result_string_p, aTmpBuf,
                     of_strlen (aTmpBuf));
            }
            goto ErrorHandler;
      ...
      case CM_DATA_ATTRIB_STR_RANGE:
               ...
               (uiStrLen > attrib_p->data_attrib.attr.string_range.max_length))
         {
            ...
            sprintf (result_p->result.error.result_string_p,
                  ...
                  (long int) attrib_p->data_attrib.attr.string_range.min_length,
                  (long int) attrib_p->data_attrib.attr.string_range.max_length);
            goto ErrorHandler;
         }
         break;
      ...
      case CM_DATA_ATTRIB_IPADDR_ENUM:
         ...
         {
            if (!strcmp (value_p, (char *) attrib_p->data_attrib.attr.ip_enum.ip_arr_a[uiCnt]))
            {
               bMatchFound = TRUE;
            }
         }
         if (bMatchFound == FALSE)
         {
            ...
            for (uiCnt = 0; uiCnt < attrib_p->data_attrib.attr.ip_enum.count_ui;
                  uiCnt++)
            {
               uiResultLen += of_strlen((char *) attrib_p->data_attrib.attr.ip_enum.ip_arr_a[uiCnt]) +2;
            }
            //uiResultLen = CM_JE_ERROR_STRING_LEN;
            result_p->result.error.result_string_p =
               (char *) of_calloc (1, uiResultLen + 100);
   ...
   if (pChannelBeginFn)
   {
      if(global_trans_b == 1)
      {
         CM_DLLQ_SCAN(&(UCMJEGloTransaction_g), xtn_entry_p, struct je_xtn_entry*)
         {
            ...
            if(cmi_dm_remove_keys_from_path(xtn_entry_p->pcDMPath,(char *)tmp_path_c,  uiPathLen ) 
                  != OF_SUCCESS)
            {
            ...
            if(of_strcmp(dm_path_p, (char *) tmp_path_c)== 0)
            {
      ...
      struct je_config_request * config_request_p)
{
   ...
   tmp_command_p->dm_path_p = of_calloc (1, of_strlen ((char *) config_request_p->dm_path_p) + 1);
   ...
   of_strncpy (tmp_command_p->dm_path_p, (char *) config_request_p->dm_path_p,
         of_strlen ((char *)config_request_p->dm_path_p));
   ...
   switch(uiNotification)
   {
      ...
      case CM_SAVE_COMPLETED_EVENT:
         ...
         CM_DLLQ_SCAN (&cm_je_request_queue_g, pDllQNode, UCMDllQNode_t *)
         {
            ...
            {
               dm_path_p=(char *) pJEPendingRequest->config_request_p->dm_path_p;
