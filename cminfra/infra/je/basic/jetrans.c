...
int32_t cm_je_read_and_process_config_request (cm_sock_handle fd_ui)
{
   ...
   uiRecvBufLen = of_mbuf_get_32((char *) aRecvBufLen);
   ...
   if (pUCMResult != NULL)
   {
      ...
      of_strncpy((char *) GenericHdr.admin_role,(char *)config_request_p->admin_role,of_strlen((char *)config_request_p->admin_role));
      of_strncpy((char *) GenericHdr.admin_name,(char *)config_request_p->admin_name,of_strlen((char *)config_request_p->admin_name));

      uiBuffLen += (2 * uiOSIntSize_g) + (6 * uiOSIntSize_g) + of_strlen((char *) config_request_p->admin_role) + of_strlen((char *) config_request_p->admin_name);
 ...
 *******************************************************************************/
 int32_t cm_je_prepare_config_request_from_message (char * pRequestBuf,
      ...
      config_request_p)
{
   unsigned char *pTmpReqBuf = (unsigned char *) pRequestBuf;
   ...
   pConfigRequest->length = of_mbuf_get_32 ((char *) pTmpReqBuf);
   pTmpReqBuf += uiOSIntSize_g;

   /* Copy command_id from buffer */
   pConfigRequest->command_id = of_mbuf_get_32 ((char *) pTmpReqBuf);
   pTmpReqBuf += uiOSIntSize_g;

   /* Copy flags from buffer */
   pConfigRequest->flags = of_mbuf_get_32 ((char *) pTmpReqBuf);
   pTmpReqBuf += uiOSIntSize_g;

   /* Copy sequence_id from buffer */
   pConfigRequest->sequence_id = of_mbuf_get_32 ((char *) pTmpReqBuf);
   pTmpReqBuf += uiOSIntSize_g;

   /* Copy mgmt_engine_id from buffer */
   pConfigRequest->mgmt_engine_id = of_mbuf_get_32 ((char *) pTmpReqBuf);
   pTmpReqBuf += uiOSIntSize_g;

   uiAdminRoleLen = of_mbuf_get_32((char *) pTmpReqBuf); 
   pTmpReqBuf += uiOSIntSize_g;
   ...
   uiAdminNameLen = of_mbuf_get_32((char *) pTmpReqBuf);
   pTmpReqBuf += uiOSIntSize_g;
   ...
   /* Copy Sub Command */
   pConfigRequest->sub_command_id = of_mbuf_get_32 ((char *) pRequestHeader);
   //  pRequestHeader += uiInt32Size_g;
   pRequestHeader += uiOSIntSize_g;

   /* Allocate Memory for DM Path  */
   uiDMPathLen = of_mbuf_get_32 ((char *) pRequestHeader);
   pRequestHeader += uiOSIntSize_g;
   if (uiDMPathLen > 0)
   {
      ...
      pConfigRequest->dm_path_p = (unsigned char *)  of_calloc (1, uiDMPathLen + 1);
   ...
   switch (pConfigRequest->sub_command_id)
   {
      ...
      case CM_CMD_GET_PER_DEVICE_STATS: 
#endif 
         /* Copy NV Pair Count */
         pConfigRequest->data.nv_pair_array.count_ui = of_mbuf_get_32 ((char *) pRequestData);
         ...
         {
            if ((cm_je_copy_nvpair_from_buffer ((char *)pRequestData,
                        &(pConfigRequest->data.
      ...
      case CM_CMD_GET_EXACT_REC:
         ...
         /* Copy Record Count */
         pConfigRequest->data.sec_appl.count_ui = of_mbuf_get_32 ((char *) pRequestData);
         pRequestData += uiOSIntSize_g;
         ...
         pConfigRequest->data.sec_appl.key_nv_pairs.count_ui =
            of_mbuf_get_32 ((char *) pRequestData);
         pRequestData += uiOSIntSize_g;
      ...
      case CM_CMD_GET_DM_FIRST_NODE_INFO:
         type = of_mbuf_get_32 ((char *) pRequestData);
      ...
      case CM_CMD_GET_DM_NEXT_TABLE_ANCHOR_NODE_INFO:
         /* Get Traversal type */
         pConfigRequest->data.data_model.type = of_mbuf_get_32 ((char *) pRequestData);
         pRequestData = pRequestData + uiOSIntSize_g;

         /* Get Opaque Info length */
         pConfigRequest->data.data_model.opaque_info_length = of_mbuf_get_32 ((char *) pRequestData);
         pRequestData = pRequestData + uiOSIntSize_g;
      ...
      case CM_CMD_IS_DM_INSTANCE_USING_NAMEPATH_AND_KEY:
         ...
         of_strncpy (pConfigRequest->data.data_model.opaque_info_p,(char *) pRequestData,
               pConfigRequest->data.data_model.opaque_info_length);
      ...
      case CM_CMD_GET_DELTA_VERSION_HISTORY:
         pConfigRequest->data.version.version = of_mbuf_get_64 ((char *)pRequestData);
         pRequestData += uiInt64Size_g;
         pConfigRequest->data.version.end_version = of_mbuf_get_64 ((char *)pRequestData);
         pRequestData += uiInt64Size_g;
         break;
         /* Notification commands */
      case CM_CMD_NOTIFY_JE:
         CM_JE_DEBUG_PRINT("CM_CMD_NOTIFY_JE Command");
         pConfigRequest->data.Notify.event = of_mbuf_get_32 ((char *) pRequestData);
         pRequestData += uiOSIntSize_g;
         pData=of_calloc(1, uiInt64Size_g);
         ulData=of_mbuf_get_64((char *)pRequestData);
         *pData=ulData;
      ...
      case CM_CMD_COALESCAR_RESP:
         pConfigRequest->data.stats_data.result_code = of_mbuf_get_32 ((char *) pRequestData);
         pRequestData += uiOSIntSize_g;
         pConfigRequest->data.stats_data.nv_pair_flat_buf_len_ui= of_mbuf_get_32 ((char *) pRequestData);
         pRequestData += uiOSIntSize_g;
      ...
      uint32_t uiBuffLen)
{
   ...
   uiGenHdrLen = (6 * uiOSIntSize_g) + of_strlen((char *) pGenericHeader->admin_role) + of_strlen((char *) pGenericHeader->admin_name);
   ...
   pUCMTempRespBuf = (char *)of_mbuf_put_32 ((char *)pUCMTempRespBuf, of_strlen((char *) pGenericHeader->admin_role));
   of_memcpy(pUCMTempRespBuf,pGenericHeader->admin_role,of_strlen((char *)pGenericHeader->admin_role));
   pUCMTempRespBuf += of_strlen((char *) pGenericHeader->admin_role);


   pUCMTempRespBuf = (char *)of_mbuf_put_32 (pUCMTempRespBuf, of_strlen((char *) pGenericHeader->admin_name));
   of_memcpy(pUCMTempRespBuf,pGenericHeader->admin_name,of_strlen((char *) pGenericHeader->admin_name));
   pUCMTempRespBuf += of_strlen((char *)pGenericHeader->admin_name);
      ...
      case CM_DATA_TYPE_IPADDR:
         {
            ...
            else if(node_info_p->data_attrib.attrib_type == CM_DATA_ATTRIB_IPADDR_ENUM)
            {
               ...
               {
                  ulDataAttrbLen += sizeof(uint32_t);
                  ulDataAttrbLen += of_strlen ((char *) node_info_p->data_attrib.attr.ip_enum.ip_arr_a[uiStrEnumCnt]);
               } 
            }
         }
         break;
      ...
      case CM_DATA_TYPE_IPV6ADDR:
         {
            ...
            else if(node_info_p->data_attrib.attrib_type == CM_DATA_ATTRIB_IPV6ADDR_ENUM)
            {
               ...
               {
                  ulDataAttrbLen += sizeof(uint32_t);
                  ulDataAttrbLen += of_strlen ((char *) node_info_p->data_attrib.attr.ipv6_enum.ip_v6_arr_a[uiStrEnumCnt]);
               }
            }
         }
         break;
      ...
      char ** buffer_pp)
{
   ...
   for (ii = 0; ii < uiNodeCnt; ii++)
   {
      ...
      if(node_info_p[ii].data_attrib.data_type == CM_DATA_TYPE_IPADDR && node_info_p[ii].data_attrib.attrib_type == CM_DATA_ATTRIB_IPADDR_ENUM)
      {
         ...
         {
            uiIPArrayLen[uiStrEnumCnt] = of_strlen((char *) node_info_p[ii].data_attrib.attr.ip_enum.ip_arr_a[uiStrEnumCnt]);
         }
      }
...
void cm_je_ldsv_init (void)
{
   ...
   of_strncpy((char *)config_request_p->admin_role, CM_VORTIQA_SUPERUSER_ROLE,UCMDM_ADMIN_ROLE_MAX_LEN);
   config_request_p->command_id = CM_COMMAND_LDSV_REQUEST;
   config_request_p->sub_command_id = CM_CMD_LOAD_CONFIG;
   config_request_p->dm_path_p = (unsigned char*) of_calloc(1,of_strlen(CM_DM_ROOT_NODE_PATH)+1);
   of_strncpy((char *)config_request_p->dm_path_p,CM_DM_ROOT_NODE_PATH,of_strlen(CM_DM_ROOT_NODE_PATH));
