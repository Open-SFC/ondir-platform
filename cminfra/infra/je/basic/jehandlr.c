      ...
      struct cm_result ** presult_p)
{
   ...
   do
   {
      ...
      pDMNode = (struct cm_dm_data_element *)cmi_dm_get_dm_node_from_instance_path
         ((char *)config_request_p->dm_path_p,of_strlen ((char *) config_request_p->dm_path_p));
      ...
      switch (config_request_p->sub_command_id)
      {
         ...
         case CM_CMD_GET_EXACT_REC:
            ...
            {
               error_code = je_validate_command (config_request_p->sub_command_id, (char *)config_request_p->dm_path_p,
      ...
      struct cm_result ** presult_p)
{
   ...
   if (dm_path_p)
   {
      ...
      uiDMPathLen = of_strlen ((char *) config_request_p->dm_path_p);
   }
   ...
   switch (config_request_p->sub_command_id)
   {
      ...
      case CM_CMD_RESET_TO_FACTORY_DEFAULTS:
         ...
         return_value = cmje_delete_subtree ((char *) config_request_p->dm_path_p, NULL, pLdsvResult,
         ...
         {
            Command.dm_path_p=(char *)of_calloc(1,of_strlen((char *)config_request_p->dm_path_p)+1);
            of_memcpy(Command.dm_path_p, config_request_p->dm_path_p, of_strlen((char *) config_request_p->dm_path_p));
         }
...
int32_t cm_je_authentication_request_handler(struct je_config_request * config_request_p, struct cm_result ** presult_p)
{
   ...
   for (ii=0; ii<uiNVPairCount; ii++)
   {
      ...
      {
         of_strncpy((char *) aUserName,config_request_p->data.nv_pair_array.nv_pairs[ii].value_p,config_request_p->data.nv_pair_array.nv_pairs[ii].value_length);
      }
      if(of_strcmp(config_request_p->data.nv_pair_array.nv_pairs[ii].name_p, "password") == 0)
      {
         of_strncpy((char *) aPassword,config_request_p->data.nv_pair_array.nv_pairs[ii].value_p,config_request_p->data.nv_pair_array.nv_pairs[ii].value_length);
      }
   }  
