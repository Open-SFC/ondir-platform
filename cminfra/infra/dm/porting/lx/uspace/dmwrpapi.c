                                       ...
                                       struct cm_array_of_uints ** pIDArray)
{
  ...
  pTmpAry->uint_arr_p = (int32_t *) of_calloc (opaque_info_length, sizeof (uint32_t));
                                ...
                                void ** opaque_info_pp, uint32_t * opaque_len_p)
{
  ...
  cm_fill_request_message (pUCMRequestMsg, CM_CMD_GET_DM_FIRST_NODE_INFO,
                         (unsigned char *) head_node_path_p, 0, NULL, NULL, &uiBuffLen);
...
//  of_mbuf_put_32 (pTmp + (uiBuffLen - sizeof (uint32_t)), traversal_type_ui);
  of_mbuf_put_32 ((char *) pTmp + (uiBuffLen - uiOSIntSize_g), traversal_type_ui);

  /*Send Message through Transport Channel */
  if ((cm_tnsprt_send_message (tnsprt_channel_p, pUCMGenericHeader,
                                   (char *) pSocketBuf, uiBuffLen)) != OF_SUCCESS)
  {
                               ...
                               void ** opaque_info_pp, uint32_t * opaque_len_p)
{
  unsigned char *pSocketBuf = NULL, *pTmp;
  int32_t return_value;
  uint32_t uiReqMsgLen, count_ui, uiBuffLen = 0;
  struct cm_msg_generic_header *pUCMGenericHeader = NULL;
  struct cm_request_msg *pUCMRequestMsg = NULL;
  struct cm_result *pResponseMsg = NULL;
  ...
  /* Append traversal type to SocketBuffer */
  pTmp = pSocketBuf;
  pTmp = (unsigned char *) of_mbuf_put_32 ((char *) pTmp + uiReqMsgLen, traversal_type_ui);

  /* Copy OpaqueInfo Len  */
  pTmp = (unsigned char *) of_mbuf_put_32 ((char *) pTmp, *opaque_len_p);
                                                      ...
                                                      uint32_t key_type)
{
  ...
  cm_fill_request_message (pUCMRequestMsg,
                        ...
                        (unsigned char *) node_path_p, 0, NULL, NULL, &uiBuffLen);
  ...
  pTmp = pSocketBuf;
  pTmp = (unsigned char *) of_mbuf_put_32 ((char *) pTmp + uiReqMsgLen, key_type);

  /* Copy Opaque Len */
  pTmp = (unsigned char *) of_mbuf_put_32 ((char *) pTmp, of_strlen (key_p));
                                                      ...
                                                      struct cm_array_of_nv_pair *nv_pair_arr_p)
{
  ...
  cm_fill_request_message (pUCMRequestMsg,
                         ...
                         (unsigned char *) node_path_p, 0, nv_pair_arr_p, NULL, &uiBuffLen);
                              ...
                              struct cm_role_info * role_info_p)
{
  ...
  cm_fill_request_message (pUCMRequestMsg, CM_CMD_IS_DM_CHILD_NODE,
                         (unsigned char *) child_path_p, 0, NULL, NULL, &uiBuffLen);
  ...
  /* Copy OpaqueInfo Len  */
  pTmp = pSocketBuf;
  pTmp = (unsigned char *) of_mbuf_put_32 ((char *)pTmp + uiReqMsgLen, of_strlen (parent_path_p));
                                      ...
                                      struct cm_role_info * role_info_p)
{
  ...
  /*Fill Request Message Structure */
  cm_fill_request_message (pUCMRequestMsg, sub_command_idID, (unsigned char *) dm_path_p,
