...
#define  CM_LDSV_LOG_FILE "/usr/local/ondir_platform/2.0/debug/ldsvdebug"
#endif
/******************************************************************************
 * * * * * * * * * * * * * * * GLOBAL VARIABLES* * * * * * * * * * * * * * * * 
 *****************************************************************************/
      ...
      int32_t ulLine, char * pFormatString, ...)
{
   ...
   cm_ldsv_trace_print_message ((unsigned char *) aTraceLoc, pFormatString, ap);
   va_end (ap);
}
